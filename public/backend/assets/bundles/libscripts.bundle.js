!function(e, t) {
    ...
    var h = function(n) {
        var e, h, b, o, r, p, f, g, w, l, u, E, T, s, x, m, a, c, v, C = "sizzle" + 1 * new Date, y = n.document, D = 0, i = 0, d = se(), _ = se(), S = se(), A = function(e, t) {
            return e === t && (u = !0),
            0
        }, N = {}.hasOwnProperty, t = [], k = t.pop, I = t.push, O = t.push, j = t.slice, L = function(e, t) {
            for (var n = 0, i = e.length; n < i; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, P = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", H = "[\\x20\\t\\r\\n\\f]", R = "(?:\\\\.|[\\w-]|[^\0-\\xa0])+", q = "\\[" + H + "*(" + R + ")(?:" + H + "*([*^$|!~]?=)" + H + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + R + "))|)" + H + "*\\]", W = ":(" + R + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + q + ")*)|.*)\\)|)", M = new RegExp(H + "+","g"), F = new RegExp("^" + H + "+|((?:^|[^\\\\])(?:\\\\.)*)" + H + "+$","g"), B = new RegExp("^" + H + "*," + H + "*"), U = new RegExp("^" + H + "*([>+~]|" + H + ")" + H + "*"), K = new RegExp("=" + H + "*([^\\]'\"]*?)" + H + "*\\]","g"), $ = new RegExp(W), Q = new RegExp("^" + R + "$"), V = {
            ID: new RegExp("^#(" + R + ")"),
            CLASS: new RegExp("^\\.(" + R + ")"),
            TAG: new RegExp("^(" + R + "|[*])"),
            ATTR: new RegExp("^" + q),
        ...
        }, Y = /^(?:input|select|textarea|button)$/i, z = /^h\d$/i, X = /^[^{]+\{\s*\[native \w/, G = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, J = /[+~]/, Z = new RegExp("\\\\([\\da-f]{1,6}" + H + "?|(" + H + ")|.)","ig"), ee = function(e, t, n) {
            var i = "0x" + t - 65536;
        ...
        E = oe.setDocument = function(e) {
            ...
            h.getElementsByClassName = X.test(T.getElementsByClassName),
            ...
            a = [],
            m = [],
            (h.qsa = X.test(T.querySelectorAll)) && (le(function(e) {
            ...
            : function(e, t) {
                ...
                if (!r || !o)
                    return e === T ? -1 : t === T ? 1 : r ? -1 : o ? 1 : l ? L(l, e) - L(l, t) : 0;
                if (r === o)
                    return ce(e, t);
        ...
        oe.matchesSelector = function(e, t) {
            ...
            t = t.replace(K, "='$1']"),
            h.matchesSelector && x && !S[t + " "] && (!a || !a.test(t)) && (!m || !m.test(t)))
                try {
                    var n = c.call(e, t);
            ...
            filter: {
                ...
                ATTR: function(n, i, r) {
                    return function(e) {
                        var t = oe.attr(e, n);
                        return null == t ? "!=" === i : !i || (t += "",
                        "=" === i ? t === r : "!=" === i ? t !== r : "^=" === i ? r && 0 === t.indexOf(r) : "*=" === i ? r && -1 < t.indexOf(r) : "$=" === i ? r && t.slice(-r.length) === r : "~=" === i ? -1 < (" " + t.replace(M, " ") + " ").indexOf(r) : "|=" === i && (t === r || t.slice(0, r.length + 1) === r + "-"))
                    }
                },
                CHILD: function(p, e, t, g, m) {
                    ...
                    : function(e, t, n) {
                        var i, r, o, s, a, l, u = v !== y ? "nextSibling" : "previousSibling", c = e.parentNode, f = _ && e.nodeName.toLowerCase(), d = !n && !_, h = !1;
                        if (c) {
                            if (v) {
                                for (; u; ) {
                                    for (s = e; s = s[u]; )
                            ...
                            y && d) {
                                for (h = (a = (i = (r = (o = (s = c)[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === D && i[1]) && i[2],
                                s = a && c.childNodes[a]; s = ++a && s && s[u] || (h = a = 0) || l.pop(); )
                                    if (1 === s.nodeType && ++h && s === e) {
                                        r[p] = [D, a, h];
                                        break
                                    }
                            } else if (d && (h = a = (i = (r = (o = (s = e)[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] || [])[0] === D && i[1]),
                            !1 === h)
                                for (; (s = ++a && s && s[u] || (h = a = 0) || l.pop()) && ((_ ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) || !++h || (d && ((r = (o = s[C] || (s[C] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] = [D, h]),
                                s !== e)); )
                                    ;
            ...
            ae(function(e, t, n, i) {
                var r, o, s, a = [], l = [], u = t.length, c = e || function(e, t, n) {
                    for (var i = 0, r = t.length; i < r; i++)
                        oe(e, t[i], n);
                    return n
                }(p || "*", n.nodeType ? [n] : n, []), f = !h || !e && p ? c : be(c, a, h, n, i), d = g ? v || (e ? h : u || m) ? [] : t : f;
                if (g && g(f, d, n, i),
                m)
                    for (r = be(d, l),
                    m(r, [], n, i),
                ...
                if (e) {
                    if (v || h) {
                        ...
                        for (o = d.length; o--; )
                            (s = d[o]) && -1 < (r = v ? L(e, s) : a[o]) && (e[r] = !(t[r] = s))
                    }
                } else
                    d = be(d === t ? d.splice(u, d.length) : d),
        ...
        f = oe.compile = function(e, t) {
            ...
            if (!s) {
                ...
                i = function(e, t, n, i, r) {
                    var o, s, a, l = 0, u = "0", c = e && [], f = [], d = w, h = e || _ && b.find.TAG("*", r), p = D += null == d ? 1 : Math.random() || .1, g = h.length;
    ...
    (C.fn.init = function(e, t, n) {
        ...
        if (!(i = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : I.exec(e)) || !i[1] && t)
                            ...
                            var n = this
                              ...
                              , e = function() {
                                ...
                                if (!(r < l)) {
                                    ...
                                    y(t) ? a ? t.call(e, u(l, o, H, a), u(l, o, R, a)) : (l++,
                                    t.call(e, u(l, o, H, a), u(l, o, R, a), u(l, o, H, o.notifyWith))) : (s !== H && (n = void 0,
                                    i = [e]),
                                    (a || o.resolveWith)(n, i))
                                }
                            }
    ...
    C.ready.then = M.then,
    "complete" === x.readyState || "loading" !== x.readyState && !x.documentElement.doScroll ? T.setTimeout(C.ready) : (x.addEventListener("DOMContentLoaded", F),
    ...
    C.extend({
        queue: function(e, t, n) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                i = z.get(e, t),
                n && (!i || Array.isArray(n) ? i = z.access(e, t, C.makeArray(n)) : i.push(n)),
                i || []
        },
    ...
    function oe(e, t, n, i) {
        ...
        , l = a(), u = n && n[3] || (C.cssNumber[t] ? "" : "px"), c = (C.cssNumber[t] || "px" !== u && +l) && te.exec(C.css(e, t));
        if (c && c[3] !== u) {
            for (l /= 2,
            u = u || c[3],
            c = +l || 1; s--; )
    ...
    function ae(e, t) {
        for (var n, i, r = [], o = 0, s = e.length; o < s; o++)
            ...
            r[o] || (i.style.display = "")),
            "" === i.style.display && ie(i) && (r[o] = (f = u = l = void 0,
            u = (a = i).ownerDocument,
            c = a.nodeName,
            (f = se[c]) || (l = u.body.appendChild(u.createElement(c)),
            f = C.css(l, "display"),
            l.parentNode.removeChild(l),
            "none" === f && (f = "block"),
            se[c] = f)))) : "none" !== n && (r[o] = "none",
            z.set(i, "display", n)));
        var a, l, u, c, f;
        for (o = 0; o < s; o++)
    ...
    C.event = {
        ...
        dispatch: function(e) {
            var t, n, i, r, o, s, a = C.event.fix(e), l = new Array(arguments.length), u = (z.get(this, "events") || {})[a.type] || [], c = C.event.special[a.type] || {};
            for (l[0] = a,
    ...
    function Le(n, i, r, o) {
        ...
        t || o)) {
            ...
            if (a)
                ...
                c = 0; c < a; c++)
                    l = s[c],
                    ce.test(l.type || "") && !z.access(l, "globalEval") && C.contains(u, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && C._evalUrl(l.src) : b(l.textContent.replace(Ne, ""), u, l))
        }
        return n
    }
    function Pe(e, t, n) {
        for (var i, r = t ? C.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
            ...
            i.parentNode && (n && C.contains(i.ownerDocument, i) && he(de(i, "script")),
        ...
        clone: function(e, t, n) {
            ...
            if (!(v.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e)))
                ...
                r = (o = de(e)).length; i < r; i++)
                    ...
                    l = s[i],
                    void 0,
                    "input" === (u = l.nodeName.toLowerCase()) && le.test(a.type) ? l.checked = a.checked : "input" !== u && "textarea" !== u || (l.defaultValue = a.defaultValue);
            if (t)
                if (n)
                    for (o = o || de(e),
                    s = s || de(c),
                    ...
                    je(e, c);
            return 0 < (s = de(c, "script")).length && he(s, !f && de(e, "script")),
            c
        },
    ...
    function We(e, t, n) {
        ...
        !v.pixelBoxStyles() && He.test(s) && qe.test(t) && (i = a.width,
        r = a.minWidth,
        o = a.maxWidth,
    ...
    C.each(["height", "width"], function(e, a) {
        C.cssHooks[a] = {
            get: function(e, t, n) {
                if (t)
                    return !Fe.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Xe(e, a, n) : re(e, Ue, function() {
                        return Xe(e, a, n)
                    })
            },
            set: function(e, t, n) {
                var i, r = Re(e), o = "border-box" === C.css(e, "boxSizing", !1, r), s = n && ze(e, a, n, o, r);
                return o && v.scrollboxSize() === r.position && (s -= Math.ceil(e["offset" + a[0].toUpperCase() + a.slice(1)] - parseFloat(r[a]) - ze(e, a, "border", !1, r) - .5)),
                s && (i = te.exec(t)) && "px" !== (i[3] || "px") && (e.style[a] = t,
                t = C.css(e, a)),
                Ye(0, t, s)
            }
        }
    ...
    function rt() {
        Ze && (!1 === x.hidden && T.requestAnimationFrame ? T.requestAnimationFrame(rt) : T.setTimeout(rt, C.fx.interval),
        C.fx.tick())
    }
    function ot() {
    ...
    C.Animation = C.extend(lt, {
        ...
        prefilters: [function(e, t, n) {
            var i, r, o, s, a, l, u, c, f = "width"in t || "height"in t, d = this, h = {}, p = e.style, g = e.nodeType && ie(e), m = z.get(e, "fxshow");
            ...
            if ((l = !C.isEmptyObject(t)) || !C.isEmptyObject(h))
                ...
                "none" === (c = C.css(e, "display")) && (u ? c = u : (ae([e], !0),
                u = e.style.display || u,
                c = C.css(e, "display"),
                ae([e]))),
    ...
    C.fn.extend({
        ...
        finish: function(s) {
            return !1 !== s && (s = s || "fx"),
            this.each(function() {
                var e, t = z.get(this), n = t[s + "queue"], i = t[s + "queueHooks"], r = C.timers, o = n ? n.length : 0;
                for (t.finish = !0,
                C.queue(this, s, []),
    ...
    C.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === e.getAttribute ? C.prop(e, t, n) : (1 === o && C.isXMLDoc(e) || (r = C.attrHooks[t.toLowerCase()] || (C.expr.match.bool.test(t) ? ut : void 0)),
        ...
        toggleClass: function(r, t) {
            ...
            return "boolean" == typeof t && s ? t ? this.addClass(r) : this.removeClass(r) : y(r) ? this.each(function(e) {
                ...
                if (s)
                    ...
                    void 0 !== r && "boolean" !== o || ((e = pt(this)) && z.set(this, "__className__", e),
                    this.setAttribute && this.setAttribute("class", e || !1 === r ? "" : z.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, i = 0;
    ...
    C.extend(C.event, {
        trigger: function(e, t, n, i) {
            ...
            if (o = f = s = n = n || x,
            3 !== n.nodeType && 8 !== n.nodeType && !vt.test(h + C.event.triggered) && (-1 < h.indexOf(".") && (h = (p = h.split(".")).shift(),
            p.sort()),
            l = h.indexOf(":") < 0 && "on" + h,
            ...
            i || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                if (!i && !c.noBubble && !_(n)) {
                    ...
                    vt.test(a + h) || (o = o.parentNode); o; o = o.parentNode)
                        d.push(o),
                        s = o;
                ...
                return e.type = h,
                i || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(d.pop(), t) || !V(n) || l && y(n[h]) && !_(n) && ((s = n[l]) && (n[l] = null),
                C.event.triggered = h,
    ...
    C.extend({
        ...
        ajax: function(e, t) {
            ...
            e = void 0),
            t = t || {};
            var c, f, d, n, h, i, p, g, r, o, m = C.ajaxSetup({}, t), v = m.context || m, y = m.context && (v.nodeType || v.jquery) ? C(v) : C.event, _ = C.Deferred(), b = C.Callbacks("once memory"), w = m.statusCode || {}, s = {}, a = {}, l = "canceled", E = {
                readyState: 0,
            ...
            m.data && (m.processData || "string" == typeof m.data) && (f += (wt.test(f) ? "&" : "?") + m.data,
            delete m.data),
            !1 === m.cache && (f = f.replace(Nt, "$1"),
            o = (wt.test(f) ? "&" : "?") + "_=" + bt++ + o),
            m.url = f + o),
    ...
    C.ajaxPrefilter("json jsonp", function(e, t, n) {
        ...
        if (s || "jsonp" === e.dataTypes[0])
            ...
            s ? e[s] = e[s].replace(Kt, "$1" + i) : !1 !== e.jsonp && (e.url += (wt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i),
    ...
    v.createHTMLDocument = ((Bt = x.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    ...
    C.parseHTML = function(e, t, n) {
        ...
        o = !n && [],
        (r = A.exec(e)) ? [t.createElement(r[1])] : (r = ve([e], t, o),
...
function(e, t) {
    ...
    function E(e, t) {
        ...
        if (e !== l && t !== l || i.contains(r))
            return "BODY" === (a = (s = l).nodeName) || "HTML" !== a && w(s.firstElementChild) !== s ? w(l) : l;
        var u = c(e);
    ...
    function O(e, n, t) {
        return (void 0 === t ? e : e.slice(0, function(e, t, n) {
            ...
            e.enabled && s(t) && (n.offsets.popper = C(n.offsets.popper),
    ...
    function u(n, i) {
        Object.keys(i).forEach(function(e) {
            var t = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(e) && h(i[e]) && (t = "px"),
            n.style[e] = i[e] + t
        })
    }
    function L(e, t, n) {
    ...
    , F = function() {
        return null == W && (W = -1 !== navigator.appVersion.indexOf("MSIE 10")),
        W
    }, B = function() {
        function i(e, t) {
    ...
    , $ = ["auto-start", "auto", "auto-end", "top-start", "top", "top-end", "right-start", "right", "right-end", "bottom-end", "bottom", "bottom-start", "left-end", "left", "left-start"], Q = $.slice(3), V = "flip", Y = "clockwise", z = "counterclockwise", X = function() {
        function o(e, t) {
            var n = this
            ...
            Object.keys(K({}, o.Defaults.modifiers, i.modifiers)).forEach(function(e) {
        ...
        modifiers: {
                ...
                fn: function(e, i) {
                    ...
                    var n = i.priority
                      ...
                      , s = {
                        primary: function(e) {
                            var t = o[e];
                            return o[e] < r[e] && !i.escapeWithReference && (t = R(o[e], r[e])),
                            U({}, e, t)
                        },
                        secondary: function(e) {
                            var t = "right" === e ? "left" : "top"
                              , n = o[t];
                            return o[e] > r[e] && !i.escapeWithReference && (n = P(o[t], r[e] - ("right" === e ? o.width : o.height))),
                            U({}, t, n)
                        }
                    };
            ...
            arrow: {
                ...
                fn: function(e, t) {
                    ...
                    return _ = R(P(s[u] - p, _), 0),
                    e.arrowElement = i,
                    e.offsets.arrow = (U(n = {}, f, Math.round(_)),
                    U(n, d, ""),
                    n),
                    e
                },
            ...
            flip: {
                ...
                enabled: !0,
                fn: function(p, g) {
                    if (e(p.instance.modifiers, "inner"))
                        return p;
                    ...
                    return b.forEach(function(e, t) {
                        ...
                        v = p.placement.split("-")[0],
                        y = N(v);
                        var n, i = p.offsets.popper, r = p.offsets.reference, o = H, s = "left" === v && o(i.right) > o(r.left) || "right" === v && o(i.left) < o(r.right) || "top" === v && o(i.bottom) > o(r.top) || "bottom" === v && o(i.top) < o(r.bottom), a = o(i.left) < o(m.left), l = o(i.right) > o(m.right), u = o(i.top) < o(m.top), c = o(i.bottom) > o(m.bottom), f = "left" === v && a || "right" === v && l || "top" === v && u || "bottom" === v && c, d = -1 !== ["top", "bottom"].indexOf(v), h = !!g.flipVariations && (d && "start" === _ && a || d && "end" === _ && l || !d && "start" === _ && u || !d && "end" === _ && c);
                        (s || f || h) && (p.flipped = !0,
                        (s || f) && (v = b[t + 1]),
                        h && (_ = "end" === (n = _) ? "start" : "start" === n ? "end" : n),
                        p.placement = v + (_ ? "-" + _ : ""),
                        p.offsets.popper = K({}, p.offsets.popper, k(p.instance.popper, p.offsets.reference, p.placement)),
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    var s, a, l = void 0 === o ? t.gpuAcceleration : o, u = D(w(e.instance.popper)), c = {
                        position: r.position
                    }, f = {
                        left: H(r.left),
                        top: H(r.top),
                        bottom: H(r.bottom),
                        right: H(r.right)
                    }, d = "bottom" === n ? "top" : "bottom", h = "right" === i ? "left" : "right", p = j("transform");
                    if (a = "bottom" == d ? -u.height + f.bottom : f.top,
                    ...
                    return e.attributes = K({}, v, e.attributes),
...
function(e, t) {
    ...
    r(document).on(f.CLICK_DATA_API, '[data-dismiss="alert"]', g._handleDismiss(new g)),
    ...
    I = function() {
        ...
        return e.toggle = function() {
            ...
            if (n) {
                ...
                if (i) {
                    if ("radio" === i.type)
                        if (i.checked && m(this._element).hasClass(E))
                            e = !1;
                        else {
                            var r = m(n).find(A)[0];
                            r && m(r).removeClass(E)
                    ...
                    if (e) {
                        if (i.hasAttribute("disabled") || n.hasAttribute("disabled") || i.classList.contains("disabled") || n.classList.contains("disabled"))
                            return;
                        i.checked = !m(this._element).hasClass(E),
                        m(i).trigger("change")
                    }
                    i.focus(),
                    t = !1
            ...
            t && this._element.setAttribute("aria-pressed", !m(this._element).hasClass(E)),
    ...
    oe = function() {
        function o(e, t) {
            ...
            this._element = O(e)[0],
            this._indicatorsElement = O(this._element).find(ne)[0],
        ...
        e.pause = function(e) {
            e || (this._isPaused = !0),
            O(this._element).find(te)[0] && (Bn.triggerTransitionEnd(this._element),
            this.cycle(!0)),
        ...
        e._getItemIndex = function(e) {
            return this._items = O.makeArray(O(e).parent().find(ee)),
        ...
        e._slide = function(e, t) {
            var n, i, r, o = this, s = O(this._element).find(Z)[0], a = this._getItemIndex(s), l = t || s && this._getItemByDirection(e, s), u = this._getItemIndex(l), c = Boolean(this._interval);
            if (r = e === M ? (n = z,
            i = X,
            B) : (n = Y,
            i = G,
            ...
            l && O(l).hasClass(Q))
                ...
                if (O(this._element).hasClass(V)) {
                    ...
                    O(s).one(Bn.TRANSITION_END, function() {
                        O(l).removeClass(n + " " + i).addClass(Q),
    ...
    Ee = function() {
        function a(e, t) {
            ...
            this._element = e,
            this._config = this._getConfig(t),
            this._triggerArray = se.makeArray(se('[data-toggle="collapse"][href="#' + e.id + '"],[data-toggle="collapse"][data-target="#' + e.id + '"]'));
            for (var n = se(we), i = 0; i < n.length; i++) {
                var r = n[i]
                  , o = Bn.getSelectorFromElement(r);
                null !== o && 0 < se(o).filter(e).length && (this._selector = o,
        ...
        e.show = function() {
            var e, t, n = this;
            if (!this._isTransitioning && !se(this._element).hasClass(pe) && (this._parent && 0 === (e = se.makeArray(se(this._parent).find(be).filter('[data-parent="' + this._config.parent + '"]'))).length && (e = null),
            !(e && (t = se(e).not(this._selector).data(le)) && t._isTransitioning))) {
                var i = se.Event(he.SHOW);
                if (se(this._element).trigger(i),
                !i.isDefaultPrevented()) {
                    e && (a._jQueryInterface.call(se(e).not(this._selector), "hide"),
                    t || se(e).data(le, null));
                    var r = this._getDimension();
                    se(this._element).removeClass(ge).addClass(me),
                    (this._element.style[r] = 0) < this._triggerArray.length && se(this._triggerArray).removeClass(ve).attr("aria-expanded", !0),
                    ...
                    se(this._element).one(Bn.TRANSITION_END, function() {
                        ...
                        se(n._element).trigger(he.SHOWN)
        ...
        e.hide = function() {
            ...
            if (!this._isTransitioning && se(this._element).hasClass(pe)) {
                ...
                if (se(this._element).trigger(t),
                !t.isDefaultPrevented()) {
                    var n = this._getDimension();
                    if (this._element.style[n] = this._element.getBoundingClientRect()[n] + "px",
                    Bn.reflow(this._element),
                    se(this._element).addClass(me).removeClass(ge).removeClass(pe),
                    0 < this._triggerArray.length)
                        for (var i = 0; i < this._triggerArray.length; i++) {
                            var r = this._triggerArray[i]
                              , o = Bn.getSelectorFromElement(r);
                            if (null !== o)
                                se(o).hasClass(pe) || se(r).addClass(ve).attr("aria-expanded", !1)
                        }
                    this.setTransitioning(!0);
                    ...
                    se(this._element).one(Bn.TRANSITION_END, function() {
                        ...
                        se(e._element).removeClass(me).addClass(ge).trigger(he.HIDDEN)
                    }).emulateTransitionEnd(s)
                }
            }
        }
        ...
        ,
        e._getConfig = function(e) {
            return (e = u({}, fe, e)).toggle = Boolean(e.toggle),
        ...
        e._getParent = function() {
            var n = this
              , e = null;
            Bn.isElement(this._config.parent) ? (e = this._config.parent,
            void 0 !== this._config.parent.jquery && (e = this._config.parent[0])) : e = se(this._config.parent)[0];
    ...
    Ge = function() {
                ...
                !t) {
                    ...
                    !i.isDefaultPrevented()) {
                        if (!this._inNavbar) {
                            ...
                            var r = this._element;
                            "parent" === this._config.reference ? r = e : Bn.isElement(this._config.reference) && (r = this._config.reference,
                            void 0 !== this._config.reference.jquery && (r = this._config.reference[0])),
                            "scrollParent" !== this._config.boundary && Te(e).addClass(Re),
                            this._popper = new c(r,this._menu,this._getPopperConfig())
                        }
                        "ontouchstart"in document.documentElement && 0 === Te(e).closest(Fe).length && Te(document.body).children().on("mouseover", null, Te.noop),
                        this._element.focus(),
                        this._element.setAttribute("aria-expanded", !0),
                        Te(this._menu).toggleClass(Oe),
                        Te(e).toggleClass(Oe).trigger(Te.Event(ke.SHOWN, n))
                    }
                }
            }
        }
        ...
        ,
        e._getConfig = function(e) {
            return e = u({}, this.constructor.Default, Te(this._element).data(), e),
            Bn.typeCheckConfig(xe, e, this.constructor.DefaultType),
            e
        }
        ,
        ...
        e._getPlacement = function() {
            var e = Te(this._element).parent()
              , t = $e;
            return e.hasClass(je) ? (t = Ue,
            Te(this._menu).hasClass(He) && (t = Ke)) : e.hasClass(Le) ? t = Ve : e.hasClass(Pe) ? t = Ye : Te(this._menu).hasClass(He) && (t = Qe),
            t
        }
        ,
        ...
        e._getPopperConfig = function() {
            ...
            "function" == typeof this._config.offset ? e.fn = function(e) {
                return e.offsets = u({}, e.offsets, t._config.offset(e.offsets) || {}),
                e
            }
                ...
                for (var t = Te.makeArray(Te(qe)), n = 0; n < t.length; n++) {
                    ...
                    if (r) {
                        ...
                        if (Te(i).hasClass(Oe) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && Te.contains(i, e.target))) {
                            ...
                            Te(i).trigger(a),
                            a.isDefaultPrevented() || ("ontouchstart"in document.documentElement && Te(document.body).children().off("mouseover", null, Te.noop),
                            t[n].setAttribute("aria-expanded", "false"),
                            Te(s).removeClass(Oe),
                            Te(i).removeClass(Oe).trigger(Te.Event(ke.HIDDEN, o)))
                        }
                    }
                }
        }
        ...
        l._dataApiKeydownHandler = function(e) {
            if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || Te(e.target).closest(Me).length)) : Ne.test(e.which)) && (e.preventDefault(),
            e.stopPropagation(),
    ...
    vt = function() {
        ...
        e._removeBackdrop = function() {
            this._backdrop && (Je(this._backdrop).remove(),
            this._backdrop = null)
        }
        ,
    ...
    Je(document).on(ot.CLICK_DATA_API, dt, function(e) {
        var t, n = this, i = Bn.getSelectorFromElement(this);
        i && (t = Je(i)[0]);
    ...
    Wt = function() {
        ...
        e.show = function() {
            ...
            if (this.isWithContent() && this._isEnabled) {
                ...
                yt.contains(this.element.ownerDocument.documentElement, this.tip) || yt(i).appendTo(a),
                ...
                yt(i).addClass(Ot),
                "ontouchstart"in document.documentElement && yt(document.body).children().on("mouseover", null, yt.noop);
                var l = function() {
        ...
        e.hide = function(e) {
            var t = this
              ...
              , r = function() {
                t._hoverState !== At && n.parentNode && n.parentNode.removeChild(n),
                t._cleanTipClass(),
            ...
            if (yt(this.element).trigger(i),
            !i.isDefaultPrevented()) {
                if (yt(n).removeClass(Ot),
                "ontouchstart"in document.documentElement && yt(document.body).children().off("mouseover", null, yt.noop),
        ...
        e.getTipElement = function() {
            return this.tip = this.tip || yt(this.config.template)[0],
            this.tip
        }
        ,
        ...
        e._setListeners = function() {
            ...
            this.config.trigger.split(" ").forEach(function(e) {
                if ("click" === e)
                    yt(i.element).on(i.constructor.Event.CLICK, i.config.selector, function(e) {
                        return i.toggle(e)
                    });
                else if (e !== qt) {
        ...
        e._enter = function(e, t) {
            ...
            (t = t || yt(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget,this._getDelegateConfig()),
            yt(e.currentTarget).data(n, t)),
            e && (t._activeTrigger["focusin" === e.type ? Ht : Pt] = !0),
            yt(t.getTipElement()).hasClass(Ot) || t._hoverState === At ? t._hoverState = At : (clearTimeout(t._timeout),
            t._hoverState = At,
        ...
        e._leave = function(e, t) {
            ...
            (t = t || yt(e.currentTarget).data(n)) || (t = new this.constructor(e.currentTarget,this._getDelegateConfig()),
            yt(e.currentTarget).data(n, t)),
            e && (t._activeTrigger["focusout" === e.type ? Ht : Pt] = !1),
        ...
        e._getConfig = function(e) {
            ...
            Bn.typeCheckConfig(_t, e, this.constructor.DefaultType),
            e
        }
        ,
        ...
        e._fixTransition = function() {
            ...
            null === e.getAttribute("x-placement") && (yt(e).removeClass(It),
    ...
    Tn = function() {
        function n(e, t) {
            ...
            this._config = this._getConfig(t),
            this._selector = this._config.target + " " + gn + "," + this._config.target + " " + vn + "," + this._config.target + " " + _n,
            this._offsets = [],
            this._targets = [],
        ...
        return e.refresh = function() {
            ...
            tn.makeArray(tn(this._selector)).map(function(e) {
                var t, n = Bn.getSelectorFromElement(e);
                if (n && (t = tn(n)[0]),
                t) {
        ...
        e._getConfig = function(e) {
            ...
            return Bn.typeCheckConfig(nn, e, ln),
            e
        }
        ,
        ...
        e._activate = function(t) {
            ...
            var n = tn(e.join(","));
            n.hasClass(cn) ? (n.closest(yn).find(bn).addClass(fn),
            n.addClass(fn)) : (n.addClass(fn),
            n.parents(pn).prev(gn + ", " + vn).addClass(fn),
    ...
    Fn = function() {
        ...
        return e.show = function() {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && xn(this._element).hasClass(kn) || xn(this._element).hasClass(In))) {
                var e, i, t = xn(this._element).closest(Pn)[0], r = Bn.getSelectorFromElement(this._element);
                if (t) {
