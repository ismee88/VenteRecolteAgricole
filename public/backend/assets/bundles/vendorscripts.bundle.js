!function(t, e) {
    ...
    var a, i, o, s, n, h, l, g, p = function(s) {
        ...
        n.supportsTransitionEnd() && (s.event.special[n.TRANSITION_END] = {
            bindType: e.end,
            delegateType: e.end,
            handle: function(t) {
    ...
    g = function() {
        ...
        return n.prototype.init = function() {
            ...
            a(this._element).find(this._config.parentTrigger).has(this._config.subMenu).children(this._config.triggerElement).on(l.CLICK_DATA_API, function(t) {
                var e = a(this)
...
function(n) {
    ...
    r.prototype.transition = function() {
        ...
        if (isNaN(p))
            t("data-transitiongoal not set");
        else {
            var e, m = Math.round(100 * (p - u) / (c - u));
            if ("center" === g.display_text && !h && !l)
                this.$back_text = h = n("<span>").addClass("progressbar-back-text").prependTo(o),
            ...
            setTimeout(function() {
                ...
                var r = setInterval(function() {
                    ...
                    v(a),
                    clearInterval(r)),
                    "none" !== g.display_text && (n = g.use_percentage ? g.percent_format(t) : g.amount_format(e, c, u),
                    "fill" === g.display_text ? a.text(n) : "center" === g.display_text && (h.text(n),
                    l.text(n))),
...
function(S, D, z) {
    ...
    t = function(A) {
        ...
        e = function() {
            ...
            ,
            1 < arguments.length ? (arguments[0] ? (t.prototype = A.extend(new arguments[0], arguments[arguments.length - 1]),
            t._super = arguments[0].prototype) : t.prototype = arguments[arguments.length - 1],
            2 < arguments.length && ((e = Array.prototype.slice.call(arguments, 1, -1)).unshift(t.prototype),
            A.extend.apply(A, e))) : t.prototype = arguments[0],
            t.prototype.cls = t
        }
        ,
        A.SPFormatClass = m = e({
            ...
            render: function(t, e, i) {
                ...
                return this.format.replace(this.fre, function() {
                    ...
                    r = arguments[3],
                    (s = h.precre.exec(n)) ? (o = s[2],
                    n = s[1]) : o = !1,
                    (a = l[n]) === z ? "" : r && e && e[r] ? e[r].get ? e[r].get(a) || a : e[r][a] || a : (g(a) && (a = i.get("numberFormatter") ? i.get("numberFormatter")(a) : p(a, o, i.get("numberDigitGroupCount"), i.get("numberDigitGroupSep"), i.get("numberDecimalMark"))),
                    a)
                })
            }
        }),
        ...
        C = function(t, e) {
            var i;
            return 2 === e ? (i = D.floor(t.length / 2),
            t.length % 2 ? t[i] : (t[i - 1] + t[i]) / 2) : t.length % 2 ? (i = (t.length * e + e) / 4) % 1 ? (t[D.floor(i)] + t[D.floor(i) - 1]) / 2 : t[i - 1] : (i = (t.length * e + 2) / 4) % 1 ? (t[D.floor(i)] + t[D.floor(i) - 1]) / 2 : t[i - 1]
        }
        ,
        E = function(t) {
            var e;
        ...
        p = function(t, e, i, s, n) {
            ...
            (r = (r = A.inArray(".", t)) < 0 ? t.length : r) < t.length && (t[r] = n),
            a = r - i; 0 < a; a -= i)
                t.splice(a, 0, s);
            return t.join("")
        }
        ...
        A.fn.simpledraw = function(t, e, i, s) {
            ...
            return t === z && (t = A(this).innerWidth()),
        ...
        u = e({
            ...
            mouseenter: function(t) {
                ...
                !this.tooltip && this.displayTooltips && (this.tooltip = new s(this.options),
            ...
            updateDisplay: function() {
                var t, e, i, s, n = this.splist, r = n.length, a = !1, o = this.$canvas.offset(), h = this.currentPageX - o.left, l = this.currentPageY - o.top;
                if (this.over) {
                    for (e = 0; e < r; e++)
                        (i = n[e].setRegionHighlight(this.currentEl, h, l)) && (a = !0);
                    if (a) {
                        if ((s = A.Event("sparklineRegionChange")).sparklines = this.splist,
                        this.$el.trigger(s),
                        this.tooltip) {
                            for (t = "",
                            e = 0; e < r; e++)
        ...
        A.fn.sparkline = function(l, i) {
            return this.each(function() {
                ...
                if (t = function() {
                    var t, e, i, s, n, r, a;
                    t = "html" === l || l === z ? ((a = this.getAttribute(o.get("tagValuesAttribute"))) !== z && null !== a || (a = h.html()),
                    a.replace(/(^\s*<!--)|(-->\s*$)|\s+/g, "").split(",")) : l,
                    e = "auto" === o.get("width") ? t.length * o.get("defaultPixelsPerValue") : o.get("width"),
                    "auto" === o.get("height") ? o.get("composite") && A.data(this, "_jqs_vcanvas") || ((s = S.createElement("span")).innerHTML = "a",
                    h.html(s),
                    i = A(s).innerHeight() || A(s).height(),
                    A(s).remove(),
                    s = null) : i = o.get("height"),
                    o.get("disableInteraction") ? n = !1 : (n = A.data(this, "_jqs_mhandler")) ? o.get("composite") || n.reset() : (n = new u(this,o),
                    A.data(this, "_jqs_mhandler", n)),
                    !o.get("composite") || A.data(this, "_jqs_vcanvas") ? ((r = new (A.fn.sparkline[o.get("type")])(this,t,o,e,i)).render(),
                    n && n.registerSparkline(r)) : A.data(this, "_jqs_errnotify") || (alert("Attempted to attach a composite sparkline to an element with no existing sparkline"),
        ...
        A.sparkline_display_visible = function() {
            ...
            i = x.length; e < i; e++)
                t = x[e][0],
                A(t).is(":visible") && !A(t).parents().is(":hidden") ? (x[e][1].call(t),
                A.data(x[e][0], "_jqs_pending", !1),
                s.push(e)) : A(t).closest("html").length || A.data(t, "_jqs_pending") || (A.data(x[e][0], "_jqs_pending", !1),
                s.push(e));
            for (e = s.length; e; e--)
                x.splice(s[e - 1], 1)
        }
        ...
        A.fn.sparkline.options = e({
            init: function(t, e) {
                ...
                this.tagOptionsPrefix = e.enableTagOptions && (e.tagOptionsPrefix || n.tagOptionsPrefix),
                i = (r = this.getTagSetting("type")) === y ? s[e.type || n.type] : s[r],
            ...
            getTagSetting: function(t) {
                ...
                if (this.tagValCache.hasOwnProperty(t))
                    ...
                    if ((e = this.tag.getAttribute(r + t)) === z || null === e)
                        e = y;
                        ...
                        e = {},
                        i = s.length; i--; )
                            e[(n = s[i].split(":", 2))[0].replace(/(^\s*)|(\s*$)/g, "")] = E(n[1].replace(/(^\s*)|(\s*$)/g, ""));
                    else
                        e = E(e);
        ...
        A.fn.sparkline._base = e({
            ...
            setRegionHighlight: function(t, e, i) {
                ...
                return e > this.canvasWidth || i > this.canvasHeight || e < 0 || i < 0 ? null : n !== (s = this.getRegion(t, e, i)) && (n !== z && r && this.removeHighlight(),
                (this.currentRegion = s) !== z && r && this.renderHighlight(),
                !0)
            },
            clearRegionHighlight: function() {
                return this.currentRegion !== z && (this.removeHighlight(),
                !(this.currentRegion = z))
            },
            ...
            getCurrentRegionTooltip: function() {
                ...
                a && o) {
                    ...
                    r = t.length; r--; )
                        l = t[r][o],
                        -1 != (c = A.inArray(l, a)) && (h[c] = t[r]);
                    t = h
                }
                for (i = e.length,
                u = t.length,
                r = 0; r < i; r++)
                    for ("string" == typeof (p = e[r]) && (p = new m(p)),
                    s = p.fclass || "jqsfield",
                    c = 0; c < u; c++)
                        t[c].isNull && d.get("tooltipSkipNull") || (A.extend(t[c], {
        ...
        n = {
            changeHighlight: function(t) {
                ...
                n && (e = this.renderRegion(i, t),
                A.isArray(e) || A.isArray(n) ? (s.replaceWithShapes(n, e),
                this.regionShapes[i] = A.map(e, function(t) {
                    return t.id
                })) : (s.replaceWithShape(n, e),
                this.regionShapes[i] = e.id))
            },
            render: function() {
        ...
        A.fn.sparkline.line = W = e(A.fn.sparkline._base, {
            ...
            renderHighlight: function() {
                var t, e, i = this.currentRegion, s = this.target, n = this.vertices[i], r = this.options, a = r.get("spotRadius"), o = r.get("highlightSpotColor"), h = r.get("highlightLineColor");
                n && (a && o && (t = s.drawCircle(n[0], n[1], a, z, o),
                this.highlightSpotId = t.id,
                s.insertAfterShape(this.lastShapeId, t)),
                h && (e = s.drawLine(n[0], this.canvasTop, n[0], this.canvasTop + this.canvasHeight, h),
            ...
            scanValues: function() {
                ...
                for (t = 0; t < a; t++)
                    ...
                    n = i && r[t].split(":"),
                    i && 2 === n.length ? (o.push(Number(n[0])),
                    h.push(Number(n[1])),
                    l.push(Number(n[1]))) : s ? (o.push(e[0]),
                    h.push(e[1]),
                    l.push(e[1])) : (o.push(t),
                    null === r[t] || "null" === r[t] ? h.push(null) : (h.push(Number(e)),
                    l.push(Number(e))));
            ...
            processRangeOptions: function() {
                ...
                e !== z && (e < this.miny && (this.miny = e),
                i > this.maxy && (this.maxy = i)),
                t.get("chartRangeMin") !== z && (t.get("chartRangeClip") || t.get("chartRangeMin") < this.miny) && (this.miny = t.get("chartRangeMin")),
                t.get("chartRangeMax") !== z && (t.get("chartRangeClip") || t.get("chartRangeMax") > this.maxy) && (this.maxy = t.get("chartRangeMax")),
                t.get("chartRangeMinX") !== z && (t.get("chartRangeClipX") || t.get("chartRangeMinX") < this.minx) && (this.minx = t.get("chartRangeMinX")),
                t.get("chartRangeMaxX") !== z && (t.get("chartRangeClipX") || t.get("chartRangeMaxX") > this.maxx) && (this.maxx = t.get("chartRangeMaxX"))
            },
            ...
            render: function() {
                var t, e, i, s, n, r, a, o, h, l, g, p, u, c, d, f, v, m, x, y, C, _, w, b, S = this.options, R = this.target, T = this.canvasWidth, M = this.canvasHeight, k = this.vertices, H = S.get("spotRadius"), I = this.regionMap;
                ...
                this.yminmax.length && !(this.yvalues.length < 2))) {
                    ...
                    H && (T < 4 * H || M < 4 * H) && (H = 0),
                    H && (((y = S.get("highlightSpotColor") && !S.get("disableInteraction")) || S.get("minSpotColor") || S.get("spotColor") && w[i] === this.miny) && (M -= D.ceil(H)),
                    (y || S.get("maxSpotColor") || S.get("spotColor") && w[i] === this.maxy) && (M -= D.ceil(H),
                    s += D.ceil(H)),
                    (y || (S.get("minSpotColor") || S.get("maxSpotColor")) && (w[0] === this.miny || w[0] === this.maxy)) && (n += D.ceil(H),
                    T -= D.ceil(H)),
                    (y || S.get("spotColor") || S.get("minSpotColor") || S.get("maxSpotColor") && (w[i] === this.miny || w[i] === this.maxy)) && (T -= D.ceil(H))),
                    M--,
                    S.get("normalRangeMin") === z || S.get("drawNormalOnTop") || this.drawNormalRange(n, s, M, T, e),
                    o = [a = []],
                    u = c = null,
                    d = w.length,
                    b = 0; b < d; b++)
                        ...
                        g = _[b + 1],
                        l = w[b],
                        c = (p = n + D.round((h - this.minx) * (T / t))) + ((b < d - 1 ? n + D.round((g - this.minx) * (T / t)) : T) - p) / 2,
                        I[b] = [u || 0, c, b],
                        u = c,
                        null === l ? b && (null !== w[b - 1] && (a = [],
                        o.push(a)),
                        k.push(null)) : (l < this.miny && (l = this.miny),
                    ...
                    m = o.length,
                    b = 0; b < m; b++)
                        (a = o[b]).length && (S.get("fillColor") && (a.push([a[a.length - 1][0], s + M]),
                        v.push(a.slice(0)),
                        a.pop()),
                    ...
                    for (m = v.length,
                    b = 0; b < m; b++)
                        R.drawShape(v[b], S.get("fillColor"), S.get("fillColor")).append();
                    for (S.get("normalRangeMin") !== z && S.get("drawNormalOnTop") && this.drawNormalRange(n, s, M, T, e),
                    m = f.length,
                    b = 0; b < m; b++)
                        R.drawShape(f[b], S.get("lineColor"), z, S.get("lineWidth")).append();
                    if (H && S.get("valueSpots"))
                        for ((x = S.get("valueSpots")).get === z && (x = new F(x)),
                        b = 0; b < d; b++)
                            (C = x.get(w[b])) && R.drawCircle(n + D.round((_[b] - this.minx) * (T / t)), s + D.round(M - M * ((w[b] - this.miny) / e)), H, z, C).append();
                    H && S.get("spotColor") && null !== w[i] && R.drawCircle(n + D.round((_[_.length - 1] - this.minx) * (T / t)), s + D.round(M - M * ((w[i] - this.miny) / e)), H, z, S.get("spotColor")).append(),
                    this.maxy !== this.minyorg && (H && S.get("minSpotColor") && (h = _[A.inArray(this.minyorg, w)],
                    R.drawCircle(n + D.round((h - this.minx) * (T / t)), s + D.round(M - M * ((this.minyorg - this.miny) / e)), H, z, S.get("minSpotColor")).append()),
                    H && S.get("maxSpotColor") && (h = _[A.inArray(this.maxyorg, w)],
                    R.drawCircle(n + D.round((h - this.minx) * (T / t)), s + D.round(M - M * ((this.maxyorg - this.miny) / e)), H, z, S.get("maxSpotColor")).append())),
        ...
        A.fn.sparkline.bar = B = e(A.fn.sparkline._base, n, {
            type: "bar",
            init: function(t, e, i, s, n) {
                var r, a, o, h, l, g, p, u, c, d, f, v, m, x, y, C, _, w, b, S, R, T = parseInt(i.get("barWidth"), 10), M = parseInt(i.get("barSpacing"), 10), k = i.get("chartRangeMin"), H = i.get("chartRangeMax"), I = i.get("chartRangeClip"), W = 1 / 0, j = -1 / 0;
                for (B._super.init.call(this, t, e, i, s, n),
                g = 0,
                p = e.length; g < p; g++)
                    ((r = "string" == typeof (S = e[g]) && -1 < S.indexOf(":")) || A.isArray(S)) && (y = !0,
                    r && (S = e[g] = N(S.split(":"))),
                    S = O(S, null),
                ...
                p = e.length; g < p; g++)
                    if (y)
                        ...
                        _ = 0,
                        w = C.length; _ < w; _++)
                            null !== (S = b[_] = I ? L(C[_], m, x) : C[_]) && (0 < S && (q[g] += S),
                            W < 0 && 0 < j ? S < 0 ? P[g] += D.abs(S) : h[g] += S : h[g] += D.abs(S - (S < 0 ? j : W)),
                            l.push(S));
                    else
                        S = I ? L(e[g], m, x) : e[g],
                ...
                i.get("chartRangeMin") !== z && (i.get("chartRangeClip") || i.get("chartRangeMin") < f) && (f = i.get("chartRangeMin")),
                i.get("chartRangeMax") !== z && (i.get("chartRangeClip") || i.get("chartRangeMax") > v) && (v = i.get("chartRangeMax")),
                this.zeroAxis = c = i.get("zeroAxis", !0),
                d = f <= 0 && 0 <= v && c ? 0 : 0 == c ? f : 0 < f ? f : v,
                this.xaxisOffset = d,
                u = y ? D.max.apply(D, h) + D.max.apply(D, P) : v - f,
                this.canvasHeightEf = c && f < 0 ? this.canvasHeight - 2 : this.canvasHeight - 1,
                f < d ? (R = ((y && 0 <= v ? j : v) - d) / u * this.canvasHeight) !== D.ceil(R) && (this.canvasHeightEf -= 2,
                R = D.ceil(R)) : R = this.canvasHeight,
                this.yoffset = R,
                A.isArray(i.get("colorMap")) ? (this.colorMapByIndex = i.get("colorMap"),
            ...
            calcColor: function(t, e, i) {
                ...
                return s = this.stacked ? o.get("stackedBarColor") : e < 0 ? o.get("negBarColor") : o.get("barColor"),
            ...
            renderRegion: function(t, e) {
                var i, s, n, r, a, o, h, l, g, p, u = this.values[t], c = this.options, d = this.xaxisOffset, f = [], v = this.range, m = this.stacked, x = this.target, y = t * this.totalBarWidth, C = this.canvasHeightEf, _ = this.yoffset;
                if (h = (u = A.isArray(u) ? u : [u]).length,
                l = u[0],
                r = w(null, u),
                p = w(d, u, !0),
                r)
                    return c.get("nullColor") ? (n = e ? c.get("nullColor") : this.calcHighlightColor(c.get("nullColor"), c),
                    i = 0 < _ ? _ - 1 : _,
                    x.drawRect(y, i, this.barWidth - 1, 0, n, n)) : z;
                for (a = _,
                o = 0; o < h; o++) {
                    if (l = u[o],
                    m && l === d) {
        ...
        A.fn.sparkline.tristate = o = e(A.fn.sparkline._base, n, {
            ...
            renderRegion: function(t, e) {
                ...
                s = h[t] < 0 ? (a = n) - 1 : 0 < h[t] ? (a = 0,
                n - 1) : (a = n - 1,
                2),
                null !== (o = this.calcColor(h[t], t)))
                    return e && (o = this.calcHighlightColor(o, l)),
        ...
        A.fn.sparkline.discrete = a = e(A.fn.sparkline._base, n, {
            ...
            init: function(t, e, i, s, n) {
                ...
                i.get("chartRangeMin") !== z && (i.get("chartRangeClip") || i.get("chartRangeMin") < this.min) && (this.min = i.get("chartRangeMin")),
                i.get("chartRangeMax") !== z && (i.get("chartRangeClip") || i.get("chartRangeMax") > this.max) && (this.max = i.get("chartRangeMax")),
                this.initTarget(),
                this.target && (this.lineHeight = "auto" === i.get("lineHeight") ? D.round(.3 * this.canvasHeight) : i.get("lineHeight"))
            },
            getRegion: function(t, e, i) {
            ...
            renderRegion: function(t, e) {
                var i, s, n, r, a = this.values, o = this.options, h = this.min, l = this.max, g = this.range, p = this.interval, u = this.target, c = this.canvasHeight, d = this.lineHeight, f = c - d;
                return s = L(a[t], h, l),
                r = t * p,
                i = D.round(f - f * ((s - h) / g)),
                n = o.get("thresholdColor") && s < o.get("thresholdValue") ? o.get("thresholdColor") : o.get("lineColor"),
        ...
        A.fn.sparkline.bullet = h = e(A.fn.sparkline._base, {
            ...
            renderRange: function(t, e) {
                ...
                return e && (n = this.calcHighlightColor(n, this.options)),
            ...
            renderPerformance: function(t) {
                ...
                return t && (s = this.calcHighlightColor(s, this.options)),
                this.target.drawRect(0, D.round(.3 * this.canvasHeight), i - 1, D.round(.4 * this.canvasHeight) - 1, s, s)
            },
            renderTarget: function(t) {
                ...
                return t && (r = this.calcHighlightColor(r, this.options)),
                this.target.drawRect(i, s, this.options.get("targetWidth") - 1, n - 1, r, r)
            },
            render: function() {
        ...
        A.fn.sparkline.pie = l = e(A.fn.sparkline._base, {
            ...
            init: function(t, e, i, s, n) {
                var r, a = 0;
                if (l._super.init.call(this, t, e, i, s, n),
                this.shapes = {},
                this.valueShapes = {},
                this.values = e = A.map(e, Number),
                ...
                this.total = a,
                this.initTarget(),
                this.radius = D.floor(D.min(this.canvasWidth, this.canvasHeight) / 2)
            },
            getRegion: function(t, e, i) {
                var s = this.target.getShapeAt(t, e, i);
                return s !== z && this.shapes[s] !== z ? this.shapes[s] : z
            ...
            renderSlice: function(t, e) {
                var i, s, n, r, a, o = this.target, h = this.options, l = this.radius, g = h.get("borderWidth"), p = h.get("offset"), u = 2 * D.PI, c = this.values, d = this.total, f = p ? 2 * D.PI * (p / 360) : 0;
                for (r = c.length,
                n = 0; n < r; n++) {
                    if (s = i = f,
                    0 < d && (s = f + u * (c[n] / d)),
                    t === n)
                        return a = h.get("sliceColors")[n % h.get("sliceColors").length],
            ...
            render: function() {
                ...
                if (l._super.render.call(this)) {
                    for (a && i.drawCircle(r, r, D.floor(r - a / 2), n.get("borderColor"), z, a).append(),
                    e = s.length; e--; )
        ...
        A.fn.sparkline.box = _ = e(A.fn.sparkline._base, {
            ...
            render: function() {
                var t, e, i, s, n, r, a, o, h, l, g, p = this.target, u = this.values, c = u.length, d = this.options, f = this.canvasWidth, v = this.canvasHeight, m = d.get("chartRangeMin") === z ? D.min.apply(D, u) : d.get("chartRangeMin"), x = d.get("chartRangeMax") === z ? D.max.apply(D, u) : d.get("chartRangeMax"), y = 0;
                if (_._super.render.call(this)) {
                    if (d.get("raw"))
                        d.get("showOutliers") && 5 < u.length ? (e = u[0],
                        t = u[1],
                        s = u[2],
                        n = u[3],
                        r = u[4],
                    ...
                    this.routlier = o,
                    g = f / (x - m + 1),
                    d.get("showOutliers") && (y = D.ceil(d.get("spotRadius")),
                    g = (f -= 2 * D.ceil(d.get("spotRadius"))) / (x - m + 1),
                    e < t && p.drawCircle((e - m) * g + y, v / 2, d.get("spotRadius"), d.get("outlierLineColor"), d.get("outlierFillColor")).append(),
                    a < o && p.drawCircle((o - m) * g + y, v / 2, d.get("spotRadius"), d.get("outlierLineColor"), d.get("outlierFillColor")).append()),
                    p.drawRect(D.round((s - m) * g + y), D.round(.1 * v), D.round((r - s) * g), D.round(.8 * v), d.get("boxLineColor"), d.get("boxFillColor")).append(),
                    p.drawLine(D.round((t - m) * g + y), D.round(v / 2), D.round((s - m) * g + y), D.round(v / 2), d.get("lineColor")).append(),
                    p.drawLine(D.round((t - m) * g + y), D.round(v / 4), D.round((t - m) * g + y), D.round(v - v / 4), d.get("whiskerColor")).append(),
                    p.drawLine(D.round((a - m) * g + y), D.round(v / 2), D.round((r - m) * g + y), D.round(v / 2), d.get("lineColor")).append(),
                    p.drawLine(D.round((a - m) * g + y), D.round(v / 4), D.round((a - m) * g + y), D.round(v - v / 4), d.get("whiskerColor")).append(),
                    p.drawLine(D.round((n - m) * g + y), D.round(.1 * v), D.round((n - m) * g + y), D.round(.9 * v), d.get("medianColor")).append(),
                    d.get("target") && (l = D.ceil(d.get("spotRadius")),
                    p.drawLine(D.round((d.get("target") - m) * g + y), D.round(v / 2 - l), D.round((d.get("target") - m) * g + y), D.round(v / 2 + l), d.get("targetColor")).append(),
                    p.drawLine(D.round((d.get("target") - m) * g + y - l), D.round(v / 2), D.round((d.get("target") - m) * g + y + l), D.round(v / 2), d.get("targetColor")).append()),
                    p.render()
                }
            }
        }),
        ...
        f = e(d, {
            ...
            _drawShape: function(t, e, i, s, n) {
                ...
                i !== z && o.stroke(),
                s !== z && o.fill(),
                this.targetX !== z && this.targetY !== z && o.isPointInPath(this.targetX, this.targetY) && (this.currentTargetShapeId = t)
            },
            ...
            _drawPieSlice: function(t, e, i, s, n, r, a, o) {
                ...
                a !== z && h.stroke(),
                o && h.fill(),
                this.targetX !== z && this.targetY !== z && h.isPointInPath(this.targetX, this.targetY) && (this.currentTargetShapeId = t)
            },
            ...
            replaceWithShapes: function(t, e) {
                ...
                for (s = t.length; s--; )
                    a[t[s]] = !0;
                for (s = r.length; s--; )
                    a[i = r[s]] && (r.splice(s, 1),
                    delete this.shapes[i],
                    n = s);
                for (s = e.length; s--; )
                    r.splice(n, 0, e[s].id),
                    this.shapes[e[s].id] = e[s]
            },
            insertAfterShape: function(t, e) {
                var i, s = this.shapeseq;
                for (i = s.length; i--; )
                    if (s[i] === t)
                        return s.splice(i + 1, 0, e.id),
        ...
        v = e(d, {
            ...
            _drawShape: function(t, e, i, s, n) {
                ...
                l = e.length; g < l; g++)
                    p[g] = e[g][0] + "," + e[g][1];
                return r = p.splice(0, 1),
                n = n === z ? 1 : n,
                a = i === z ? ' stroked="false" ' : ' strokeWeight="' + n + 'px" strokeColor="' + i + '" ',
                o = s === z ? ' filled="false"' : ' fillColor="' + s + '" filled="true" ',
                h = p[0] === p[p.length - 1] ? "x " : "",
                '<v:shape coordorigin="0 0" coordsize="' + this.pixelWidth + " " + this.pixelHeight + '"  id="jqsshape' + t + '" ' + a + o + ' style="position:absolute;left:0px;top:0px;height:' + this.pixelHeight + "px;width:" + this.pixelWidth + 'px;padding:0px;margin:0px;"  path="m ' + r + " l " + p.join(", ") + " " + h + 'e"> </v:shape>'
            },
            _drawCircle: function(t, e, i, s, n, r, a) {
            ...
            _drawPieSlice: function(t, e, i, s, n, r, a, o) {
                ...
                return l === p && g === u && r - n < D.PI ? "" : (h = [e - s, i - s, e + s, i + s, l, g, p, u],
                c = a === z ? ' stroked="false" ' : ' strokeWeight="1px" strokeColor="' + a + '" ',
                d = o === z ? ' filled="false"' : ' fillColor="' + o + '" filled="true" ',
                '<v:shape coordorigin="0 0" coordsize="' + this.pixelWidth + " " + this.pixelHeight + '"  id="jqsshape' + t + '" ' + c + d + ' style="position:absolute;left:0px;top:0px;height:' + this.pixelHeight + "px;width:" + this.pixelWidth + 'px;padding:0px;margin:0px;"  path="m ' + e + "," + i + " wa " + h.join(", ") + ' x e"> </v:shape>')
            },
            _drawRect: function(t, e, i, s, n, r, a) {
