    ...
    s.o = function() {
        ...
        this._touch = function(t) {
            var i = function(t) {
                ...
                i != h.cv && (h.cH && !1 === h.cH(i) || (h.change(h._validate(i)),
                h._draw()))
            };
            return this.t = s.c.t(t),
            i(t),
            s.c.d.bind("touchmove.k", i).bind("touchend.k", function() {
                s.c.d.unbind("touchmove.k touchend.k"),
                h.val(h.cv)
            }),
            this
        }
        ...
        this._mouse = function(t) {
            ...
            return i(t),
            s.c.d.bind("mousemove.k", i).bind("keyup.k", function(t) {
                if (27 === t.keyCode) {
                    if (s.c.d.unbind("mouseup.k mousemove.k keyup.k"),
                    h.eH && !1 === h.eH())
                        return;
                    h.cancel()
                }
            }).bind("mouseup.k", function(t) {
                s.c.d.unbind("mousemove.k mouseup.k keyup.k"),
                h.val(h.cv)
            }),
            this
        }
        ...
        this._listen = function() {
            ...
            this.listen()),
            this.relative && c(window).resize(function() {
                h._carve().init(),
                h._draw()
            }),
            this
        ...
        this.h2rgba = function(t, i) {
            ...
            "rgba(" + (s = [parseInt(t.substring(0, 2), 16), parseInt(t.substring(2, 4), 16), parseInt(t.substring(4, 6), 16)])[0] + "," + s[1] + "," + s[2] + "," + i + ")"
        }
        ,
    ...
    s.Dial = function() {
        ...
        this.val = function(t, i) {
            if (null == t)
                return this.v;
            t = this.o.parse(t),
            !1 !== i && t != this.v && this.rH && !1 === this.rH(t) || (this.cv = this.o.stopper ? u(d(t, this.o.max), this.o.min) : t,
            this.v = this.cv,
            this.$.val(this.o.format(this.v)),
            this._draw())
        }
        ...
        this.xy2val = function(t, i) {
            ...
            this.angleArc != this.PI2 && s < 0 && -.5 < s ? s = 0 : s < 0 && (s += this.PI2),
        ...
        this.listen = function() {
            ...
            this.$.bind("keydown", function(t) {
                var i = t.keyCode;
                if (96 <= i && i <= 105 && (i = t.keyCode = i - 48),
                ...
                isNaN(h) ? n && (window.clearTimeout(n),
                n = null,
                r = 1,
        ...
        this.arc = function(t) {
            ...
            s = this.o.flip ? (i = this.endAngle + 1e-5) - t - 1e-5 : (i = this.startAngle - 1e-5) + t + 1e-5,
