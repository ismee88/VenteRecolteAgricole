!function(t, e) {
    ...
    , function(t, e, i) {
        ...
        void 0 === (n = function(z) {
            function I(t) {
                ...
                if (I.is(t, T))
                    return I._engine.create[b](I, t.splice(0, 3 + I.is(t[0], Y))).add(t);
            ...
            function O(s, o, a) {
                return function t() {
                    ...
                    }(n, i) : (1e3 <= n.length && delete r[n.shift()],
                    n.push(i),
                    r[i] = s[b](o, e)),
                    a ? a(r[i]) : r[i]
                }
                ...
                if (!(M(t, i) < L(n, o) || L(t, i) > M(n, o) || M(e, r) < L(s, a) || L(e, r) > M(s, a))) {
                    ...
                    if (h) {
                        var l = ((t * r - e * i) * (n - o) - (t - i) * (n * a - s * o)) / h
                          ...
                          , c = +l.toFixed(2)
                          , p = +u.toFixed(2);
                        if (!(c < +L(t, i).toFixed(2) || c > +M(t, i).toFixed(2) || c < +L(n, o).toFixed(2) || c > +M(n, o).toFixed(2) || p < +L(e, r).toFixed(2) || p > +M(e, r).toFixed(2) || p < +L(s, a).toFixed(2) || p > +M(s, a).toFixed(2)))
                            return {
                                x: l,
                                y: u
                            }
            ...
            function k(t, e, i) {
                ...
                for (f = 0; f < a; f++)
                    for (var g = 0; g < h; g++) {
                        ...
                        if (_) {
                            if (c[_.x.toFixed(4)] == _.y.toFixed(4))
                                continue;
            ...
            function n(t, e, i) {
                ...
                for (var r, n, s, o, a, h, l, u, c, p, f = i ? 0 : [], d = 0, g = t.length; d < g; d++) {
                    ...
                    if ("M" == x[0])
                        ...
                        n = "C" == x[0] ? (r = (c = [r, n].concat(x.slice(1)))[6],
                        c[7]) : (c = [r, n, r, n, a, h, a, h],
                        r = a,
                        h);
                        for (var v = 0, y = e.length; v < y; v++) {
                            ...
                            if ("M" == m[0])
                                ...
                                o = "C" == m[0] ? (s = (p = [s, o].concat(m.slice(1)))[6],
                                p[7]) : (p = [s, o, s, o, l, u, l, u],
                                s = l,
                                u);
                                var b = k(c, p, i);
                                if (i)
            ...
            function R(t, e, i, r, n, s) {
                ...
                var o, l = 3 * e, u = 3 * (r - e) - l, c = 1 - l - u, a = 3 * i, p = 3 * (n - i) - a, f = 1 - a - p;
            ...
            function _(t, e, i, r, n, s) {
                i = $(i);
                var o, a, h, l, u, c, p = t.ms, f = {}, d = {}, g = {};
                if (r)
                    for (v = 0,
                    y = re.length; v < y; v++) {
                        var x = re[v];
                        if (x.el.id == e.id && x.anim == t) {
                            x.percent != i ? (re.splice(v, 1),
                            h = 1) : a = x,
                            ...
                            if (o[N](m) && (K[N](m) || e.paper.customAttributes[N](m)))
                                ...
                                case "transform":
                                    ...
                                    if (B)
                                        ...
                                        Dt(L, d[m]),
                                        d[m] = L._.transform,
                                        g[m] = [(L.matrix.a - M.a) / p, (L.matrix.b - M.b) / p, (L.matrix.c - M.c) / p, (L.matrix.d - M.d) / p, (L.matrix.e - M.e) / p, (L.matrix.f - M.f) / p]
                                    }
                                    break;
                                case "csv":
                                    var F = G(o[m])[X](H)
                                ...
                                default:
                                    ...
                                    T = [][j](f[m]),
                                    g[m] = [],
                                    v = e.paper.customAttributes[m].length; v--; )
                                        g[m][v] = ((F[v] || 0) - (T[v] || 0)) / p
                                }
                        var A = o.easing
            ...
            }, b = "apply", j = "concat", g = "ontouchstart"in d.win || d.win.DocumentTouch && d.doc instanceof DocumentTouch, C = " ", G = String, X = "split", c = "click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend touchcancel"[X](C), p = {
                mousedown: "touchstart",
                mousemove: "touchmove",
                mouseup: "touchend"
            }, w = G.prototype.toLowerCase, q = Math, M = q.max, L = q.min, V = q.abs, F = q.pow, U = q.PI, Y = "number", f = "string", T = "array", x = Object.prototype.toString, A = (I._ISURL = /^url\(['"]?(.+?)['"]?\)$/i,
            /^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgba?\(\s*([\d\.]+%?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+%?)?)\s*\)|hsba?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\)|hsla?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\))\s*$/i), E = {
                ...
                Infinity: 1,
                "-Infinity": 1
            }, W = /^(?:cubic-)?bezier\(([^,]+),([^,]+),([^,]+),([^\)]+)\)/, P = q.round, $ = parseFloat, Z = parseInt, Q = G.prototype.toUpperCase, J = I._availableAttrs = {
                "arrow-end": "none",
                "arrow-start": "none",
                blur: 0,
                ...
                hs: 1,
                rg: 1
            }, it = /,?([achlmqrstvxz]),?/gi, rt = /([achlmrqstvz])[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*)+)/gi, nt = /([rstm])[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*)+)/gi, st = /(-?\d*\.?\d*(?:e[\-+]?\d+)?)[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*/gi, ot = (I._radial_gradient = /^r(?:\(([^,]+?)[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*([^\)]+?)\))?/,
            {}), at = function(t, e) {
                return $(t) - $(e)
            }, ht = function(t) {
                return t
            ...
            , ut = function(t, e, i, r) {
                ...
                var i, r, n, s, o, a, h;
                for (n = 0,
                o = (t = Pt(t)).length; n < o; n++)
                    for (s = 1,
                    a = (h = t[n]).length; s < a; s += 2)
                        i = e.x(h[s], h[s + 1]),
                        r = e.y(h[s], h[s + 1]),
                        h[s] = i,
                        h[s + 1] = r;
            ...
            ;
            if (I._g = d,
            "VML" == (I.type = d.win.SVGAngle || d.doc.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") ? "SVG" : "VML")) {
                var ft, dt = d.doc.createElement("div");
                if (dt.innerHTML = '<v:shape adj="1"/>',
            ...
            var vt = function(t) {
              ...
              , wt = function(t, e, i) {
                if (null == e && I.is(t, "object") && "r"in t && "g"in t && "b"in t && (i = t.b,
                e = t.g,
                t = t.r),
                null == e && I.is(t, f)) {
                    var r = I.getRGB(t);
              ...
              , _t = function(t, e, i, r) {
                ...
                return I.is(r, "finite") && (n.opacity = r),
                n
            };
            I.color = function(t) {
                var e;
                return I.is(t, "object") && "h"in t && "s"in t && "b"in t ? (e = I.hsb2rgb(t),
                t.r = e.r,
                t.g = e.g,
                t.b = e.b,
                t.hex = e.hex) : I.is(t, "object") && "h"in t && "s"in t && "l"in t ? (e = I.hsl2rgb(t),
                t.r = e.r,
                t.g = e.g,
                t.b = e.b,
                t.hex = e.hex) : (I.is(t, "string") && (t = I.getRGB(t)),
                I.is(t, "object") && "r"in t && "g"in t && "b"in t ? (e = I.rgb2hsl(t),
                t.h = e.h,
                t.s = e.s,
                t.l = e.l,
                e = I.rgb2hsb(t),
            ...
            I.hsb2rgb = function(t, e, i, r) {
                ...
                r = t.o,
                t = t.h),
                a = (h = i * e) * (1 - V((t = (t *= 360) % 360 / 60) % 2 - 1)),
                n = s = o = i - h,
                _t(n += [h, a, 0, 0, a, h][t = ~~t], s += [a, h, h, a, 0, 0][t], o += [0, 0, a, h, h, a][t], r)
            }
            ,
            I.hsl2rgb = function(t, e, i, r) {
                ...
                e /= 100,
                i /= 100),
                a = (h = 2 * e * (i < .5 ? i : 1 - i)) * (1 - V((t = (t *= 360) % 360 / 60) % 2 - 1)),
                n = s = o = i - h / 2,
                _t(n += [h, a, 0, 0, a, h][t = ~~t], s += [a, h, h, a, 0, 0][t], o += [0, 0, a, h, h, a][t], r)
            }
            ,
            ...
            I.getRGB = O(function(t) {
                ...
                return a ? (a[2] && (r = Z(a[2].substring(5), 16),
                i = Z(a[2].substring(3, 5), 16),
                e = Z(a[2].substring(1, 3), 16)),
                a[3] && (r = Z((s = a[3].charAt(3)) + s, 16),
                ...
                r = $(o[2]),
                "%" == o[2].slice(-1) && (r *= 2.55),
                ("deg" == o[0].slice(-3) || "°" == o[0].slice(-1)) && (e /= 360),
                "hsba" == a[1].toLowerCase().slice(0, 4) && (n = $(o[3])),
                o[3] && "%" == o[3].slice(-1) && (n /= 100),
                I.hsb2rgb(e, i, r, n)) : a[6] ? (o = a[6][X](tt),
                e = $(o[0]),
                "%" == o[0].slice(-1) && (e *= 2.55),
                i = $(o[1]),
                "%" == o[1].slice(-1) && (i *= 2.55),
                ...
                I.hsl2rgb(e, i, r, n)) : ((a = {
                    ...
                    b: r,
                    toString: h
                }).hex = "#" + (16777216 | r | i << 8 | e << 16).toString(16).slice(1),
            ...
            I.parsePathString = function(t) {
                ...
                var s = {
                  ...
                  , o = [];
                return I.is(t, T) && I.is(t[0], T) && (o = St(t)),
                o.length || G(t).replace(rt, function(t, e, i) {
                    var r = []
                      , n = e.toLowerCase();
                    if (i.replace(st, function(t, e) {
                        e && r.push(+e)
                    }),
                    "m" == n && 2 < r.length && (o.push([e][j](r.splice(0, 2))),
                    n = "l",
                    e = "m" == e ? "l" : "L"),
                    "r" == n)
                        o.push([e][j](r));
                    else
                        for (; r.length >= s[n] && (o.push([e][j](r.splice(0, s[n]))),
                        s[n]); )
                            ;
                }),
            ...
            I.parseTransformString = O(function(t) {
                if (!t)
                    return null;
                var n = [];
                return I.is(t, T) && I.is(t[0], T) && (n = St(t)),
                n.length || G(t).replace(nt, function(t, e, i) {
                    var r = [];
                    w.call(e);
            ...
            var Ct = I.pathBBox = function(t) {
              ...
              , Bt = I._pathToRelative = function(t) {
                ...
                return i.toString = I._path2string,
                e.rel = St(i),
                i
            }
              , Mt = I._pathToAbsolute = function(t) {
                ...
                if (e.abs)
                    return St(e.abs);
                if (I.is(t, T) && I.is(t && t[0], T) || (t = I.parsePathString(t)),
                !t || !t.length)
                    return [["M", 0, 0]];
                var i = []
                  , r = 0
                ...
                for (var h, l, u = 3 == t.length && "M" == t[0][0] && "R" == t[1][0].toUpperCase() && "Z" == t[2][0].toUpperCase(), c = a, p = t.length; c < p; c++) {
                    ...
                    (l = t[c])[0] != Q.call(l[0]))
                        ...
                        case "H":
                            ...
                            break;
                        case "R":
                            for (var f = [r, n][j](l.slice(1)), d = 2, g = f.length; d < g; d++)
                                f[d] = +f[d] + r,
                                f[++d] = +f[d] + n;
                            i.pop(),
                            i = i[j](y(f, u));
              ...
              , Tt = function(t, e, i, r, n, s, o, a, h, l) {
                var u, c = 120 * U / 180, p = U / 180 * (+n || 0), f = [], d = O(function(t, e, i) {
                    return {
                ...
                l)
                    return [R, H, N][j](f);
                for (var G = [], Y = 0, W = (f = [R, H, N][j](f).join()[X](",")).length; Y < W; Y++)
                    G[Y] = Y % 2 ? d(f[Y - 1], f[Y], p).y : d(f[Y], f[Y + 1], p).x;
                return G
            }
              ...
              , Et = O(function(t, e, i, r, n, s, o, a) {
                var h, l = n - 2 * i + t - (o - 2 * n + i), u = 2 * (i - t) - 2 * (n - i), c = t - i, p = (-u + q.sqrt(u * u - 4 * l * c)) / 2 / l, f = (-u - q.sqrt(u * u - 4 * l * c)) / 2 / l, d = [e, a], g = [t, o];
                return "1e12" < V(p) && (p = .5),
                "1e12" < V(f) && (f = .5),
                0 < p && p < 1 && (h = At(t, e, i, r, n, s, o, a, p),
                g.push(h.x),
                d.push(h.y)),
                0 < f && f < 1 && (h = At(t, e, i, r, n, s, o, a, f),
                g.push(h.x),
                d.push(h.y)),
                l = s - 2 * r + e - (a - 2 * s + r),
                c = e - r,
                p = (-(u = 2 * (r - e) - 2 * (s - r)) + q.sqrt(u * u - 4 * l * c)) / 2 / l,
              ...
              , Pt = I._path2curve = O(function(t, e) {
                ...
                for (var s = Mt(t), o = e && Mt(e), r = {
                    ...
                    case "T":
                        ...
                        e.qy = e.y),
                        t = ["C"][j](Ft(e.x, e.y, e.qx, e.qy, t[1], t[2]));
                        break;
                    case "Q":
                        e.qx = t[1],
                        e.qy = t[2],
                        t = ["C"][j](Ft(e.x, e.y, t[1], t[2], t[3], t[4]));
                        break;
                    case "L":
                    ...
                    t && e && "M" == t[n][0] && "M" != e[n][0] && (e.splice(n, 0, ["M", r.x, r.y]),
                    i.bx = 0,
                    i.by = 0,
                    i.x = t[n][1],
                    i.y = t[n][2],
            ...
            I._extractTransform = function(t, e) {
                ...
                var i, r, n = I.parseTransformString(e), s = 0, o = 1, a = 1, h = t._, l = new D;
                if (h.transform = n || [],
                n)
                    for (var u = 0, c = n.length; u < c; u++) {
                        var p, f, d, g, x, v = n[u], y = v.length, m = G(v[0]).toLowerCase(), b = v[0] != m, w = b ? l.invert() : 0;
                        "t" == m && 3 == y ? b ? (p = w.x(0, 0),
                        f = w.y(0, 0),
                        d = w.x(v[1], v[2]),
                        g = w.y(v[1], v[2]),
                        l.translate(d - p, g - f)) : l.translate(v[1], v[2]) : "r" == m ? 2 == y ? (x = x || t.getBBox(1),
                        l.rotate(v[1], x.x + x.width / 2, x.y + x.height / 2),
                        s += v[1]) : 4 == y && (b ? (d = w.x(v[2], v[3]),
                        g = w.y(v[2], v[3]),
                        l.rotate(v[1], d, g)) : l.rotate(v[1], v[2], v[3]),
                        s += v[1]) : "s" == m ? 2 == y || 3 == y ? (x = x || t.getBBox(1),
                        l.scale(v[1], v[y - 1], x.x + x.width / 2, x.y + x.height / 2),
                        o *= v[1],
                        a *= v[y - 1]) : 5 == y && (b ? (d = w.x(v[3], v[4]),
                        g = w.y(v[3], v[4]),
                        l.scale(v[1], v[2], d, g)) : l.scale(v[1], v[2], v[3], v[4]),
                        o *= v[1],
                        a *= v[2]) : "m" == m && 7 == y && l.add(v[1], v[2], v[3], v[4], v[5], v[6]),
                        h.dirtyT = 1,
                        t.matrix = l
                    }
                t.matrix = l,
                ...
                h.dx = i = l.e,
                h.dy = r = l.f,
                1 == o && 1 == a && !s && h.bbox ? (h.bbox.x += +i,
                h.bbox.y += +r) : h.dirtyT = 1
            }
            )
              , Rt = function(t) {
                var e = t[0];
            ...
            function(t) {
                ...
                t.add = function(t, e, i, r, n, s) {
                    var o, a, h, l, u = [[], [], []], c = [[this.a, this.c, this.e], [this.b, this.d, this.f], [0, 0, 1]], p = [[t, i, n], [e, r, s], [0, 0, 1]];
                    for (t && t instanceof D && (p = [[t.a, t.c, t.e], [t.b, t.d, t.f], [0, 0, 1]]),
                    o = 0; o < 3; o++)
                        for (a = 0; a < 3; a++) {
                            for (h = l = 0; h < 3; h++)
                                l += c[o][h] * p[h][a];
                ...
                t.split = function() {
                    ...
                    var i = -e[0][1]
                      , r = e[1][1];
                    return r < 0 ? (t.rotate = I.deg(q.acos(r)),
                    i < 0 && (t.rotate = 360 - t.rotate)) : t.rotate = I.deg(q.asin(i)),
                ...
                t.toTransformString = function(t) {
                    ...
                    (e.dx || e.dy ? "t" + [e.dx, e.dy] : "") + (1 != e.scalex || 1 != e.scaley ? "s" + [e.scalex, e.scaley, 0, 0] : "") + (e.rotate ? "r" + [e.rotate, 0, 0] : "")) : "m" + [this.get(0), this.get(1), this.get(2), this.get(3), this.get(4), this.get(5)]
                }
            }(D.prototype);
            for (var Nt = function() {
                this.returnValue = !1
            ...
            : d.doc.attachEvent ? function(t, e, s, o) {
                var i = function(t) {
                    ...
                    var e = d.doc.documentElement.scrollTop || d.doc.body.scrollTop
                      ...
                      , r = t.clientX + i
                      , n = t.clientY + e;
                    return t.preventDefault = t.preventDefault || Nt,
            ...
            : void 0, Xt = [], qt = function(t) {
                for (var e, i = t.clientX, r = t.clientY, n = d.doc.documentElement.scrollTop || d.doc.body.scrollTop, s = d.doc.documentElement.scrollLeft || d.doc.body.scrollLeft, o = Xt.length; o--; ) {
                    ...
                    g && t.touches) {
                        ...
                        t.preventDefault();
                    var l, u = e.el.node, c = u.nextSibling, p = u.parentNode, f = u.style.display;
                    ...
                    i += s,
                    r += n,
                    z("raphael.drag.move." + e.el.id, e.move_scope || e.el, i - e.el._drag.x, r - e.el._drag.y, i, r, t)
                }
            }, Vt = function(t) {
                I.unmousemove(qt).unmouseup(Vt);
                for (var e, i = Xt.length; i--; )
                    (e = Xt[i]).el._drag = {},
                    z("raphael.drag.end." + e.el.id, e.end_scope || e.start_scope || e.move_scope || e.el, t);
                Xt = []
            }, Ut = I.el = {}, $t = c.length; $t--; )
                !function(r) {
                    ...
                    I["un" + r] = Ut["un" + r] = function(t) {
                        for (var e = this.events || [], i = e.length; i--; )
                            e[i].name != r || !I.is(t, "undefined") && e[i].f != t || (e[i].unbind(),
                            e.splice(i, 1),
            ...
            Ut.data = function(t, e) {
                ...
                if (I.is(t, "object")) {
                    for (var r in t)
                        t[N](r) && this.data(r, t[r]);
                    return this
                }
                return z("raphael.data.get." + this.id, this, i[t], t),
                i[t]
            }
            ,
            Ut.removeData = function(t) {
                return null == t ? ot[this.id] = {} : ot[this.id] && delete ot[this.id][t],
                this
            }
            ,
            Ut.getData = function() {
            ...
            Ut.drag = function(a, h, l, u, c, p) {
                function t(t) {
                    ...
                    z("raphael.drag.start." + this.id, c || u || this, t.clientX + n, t.clientY + r, t)
                }
                return this._drag = {},
                Zt.push({
                    el: this,
            ...
            Ut.undrag = function() {
                for (var t = Zt.length; t--; )
                    Zt[t].el == this && (this.unmousedown(Zt[t].start),
                    Zt.splice(t, 1),
                    z.unbind("raphael.drag.*." + this.id));
                !Zt.length && I.unmousemove(qt).unmouseup(Vt),
                Xt = []
            }
            ,
            ...
            e.getElementByPoint = function(t, e) {
                var i, r, n, s, o, a, h, l = this.canvas, u = d.doc.elementFromPoint(t, e);
                if (d.win.opera && "svg" == u.tagName) {
                    var c = (r = (i = l).getBoundingClientRect(),
                    n = i.ownerDocument,
                    s = n.body,
                    o = n.documentElement,
            ...
            Ut.isPointInside = function(t, e) {
                ...
                return this.attr("transform") && this.attr("transform").length && (i = I.transformPath(i, this.attr("transform"))),
            ...
            Ut.getBBox = function(t) {
                if (this.removed)
                    return {};
                var e = this._;
                return t ? (!e.dirty && e.bboxwt || (this.realPath = ct[this.type](this),
            ...
            var Qt = function(t, e, i, r, n, s, o, a, h) {
                return null == h ? S(t, e, i, r, n, s, o, a) : I.findDotsAtSegment(t, e, i, r, n, s, o, a, function(t, e, i, r, n, s, o, a, h) {
                    if (!(h < 0 || S(t, e, i, r, n, s, o, a) < h)) {
                        var l, u = .5, c = 1 - u;
                        for (l = S(t, e, i, r, n, s, o, a, c); .01 < V(l - h); )
                            l = S(t, e, i, r, n, s, o, a, c += (l < h ? 1 : -1) * (u /= 2));
                        return c
                    }
                }(t, e, i, r, n, s, o, a, h))
            }
              , Jt = function(f, d) {
                return function(t, e, i) {
                    for (var r, n, s, o, a, h = "", l = {}, u = 0, c = 0, p = (t = Pt(t)).length; c < p; c++) {
                        if ("M" == (s = t[c])[0])
                            ...
                            if (e < u + (o = Qt(r, n, s[1], s[2], s[3], s[4], s[5], s[6]))) {
                                if (d && !l.start) {
                                    if (h += ["C" + (a = Qt(r, n, s[1], s[2], s[3], s[4], s[5], s[6], e - u)).start.x, a.start.y, a.m.x, a.m.y, a.x, a.y],
                                    i)
                                        return h;
                                    l.start = h,
                    ...
                    return l.end = h,
                    (a = f ? u : d ? l : I.findDotsAtSegment(r, n, s[0], s[1], s[2], s[3], s[4], s[5], 1)).alpha && (a = {
                        x: a.x,
                        y: a.y,
                        alpha: a.alpha
                    }),
              ...
              , se = function() {
                for (var t = +new Date, e = 0; e < re.length; e++) {
                    ...
                    if (!i.el.removed && !i.paused) {
                        var r, n, s = t - i.start, o = i.ms, a = i.easing, h = i.from, l = i.diff, u = i.to, c = (i.t,
                        i.el), p = {}, f = {};
                        if (i.initstatus ? (s = (i.initstatus * i.anim.top - i.prev) / (i.percent - i.prev) * o,
                        i.status = i.initstatus,
                        delete i.initstatus,
                        i.stop && re.splice(e--, 1)) : i.status = (i.prev + (i.percent - i.prev) * (s / o)) / i.anim.top,
                        !(s < 0))
                            if (s < o) {
                                var d = a(s / o);
                                for (var g in h)
                                    if (h[N](g)) {
                                        ...
                                        case "path":
                                            ...
                                            for (var x = 0, v = h[g].length; x < v; x++) {
                                                r[x] = [h[g][x][0]];
                                                for (var y = 1, m = h[g][x].length; y < m; y++)
                                        ...
                                        default:
                                            var w = [][j](h[g]);
                                            for (r = [],
                                            x = c.paper.customAttributes[g].length; x--; )
                                                r[x] = +w[x] + d * o * l[g][x]
                                        }
                                        p[g] = r
                                    }
                                ...
                                1 < i.repeat && !i.next) {
                                    for (n in u)
                                        u[N](n) && (f[n] = i.totalOrigin[n]);
                                    i.el.attr(f),
                                    _(i.anim, i.el, i.anim.percents[0], null, i.totalOrigin, i.repeat - 1)
                                }
            ...
            Ut.onAnimation = function(t) {
                return t ? z.on("raphael.anim.frame." + this.id, t) : z.unbind("raphael.anim.frame." + this.id),
                this
            }
            ,
            ...
            Ut.animate = function(t, e, i, r) {
                ...
                return _(s, n, s.percents[0], null, n.attr()),
                n
            }
            ,
            Ut.setTime = function(t, e) {
                return t && null != e && this.status(t, L(e, t.ms) / t.ms),
                this
            }
            ,
            ...
            Ut.pause = function(t) {
                for (var e = 0; e < re.length; e++)
                    re[e].el.id != this.id || t && re[e].anim != t || !1 !== z("raphael.anim.pause." + this.id, this, re[e].anim) && (re[e].paused = !0);
                return this
            }
            ,
            Ut.resume = function(t) {
                for (var e = 0; e < re.length; e++)
                    if (re[e].el.id == this.id && (!t || re[e].anim == t)) {
                        var i = re[e];
                        !1 !== z("raphael.anim.resume." + this.id, this, i.anim) && (delete i.paused,
            ...
            Ut.stop = function(t) {
                for (var e = 0; e < re.length; e++)
                    re[e].el.id != this.id || t && re[e].anim != t || !1 !== z("raphael.anim.stop." + this.id, this, re[e].anim) && re.splice(e--, 1);
                return this
            }
            ,
            ...
            var ae, he, le, ue, ce, pe = function(t) {
                ...
                t)
                    for (var e = 0, i = t.length; e < i; e++)
                        !t[e] || t[e].constructor != Ut.constructor && t[e].constructor != pe || (this[this.items.length] = this.items[this.items.length] = t[e],
                        this.length++)
            }, fe = pe.prototype;
            for (var de in fe.push = function() {
                for (var t, e, i = 0, r = arguments.length; i < r; i++)
                    !(t = arguments[i]) || t.constructor != Ut.constructor && t.constructor != pe || (this[e = this.items.length] = this.items[e] = t,
                    this.length++);
                return this
            }
            ,
            ...
            fe.animate = function(t, e, i, r) {
                ...
                var n, s, o = this.items.length, a = o, h = this;
                if (!o)
                    return this;
                r && (s = function() {
                    !--o && r.call(h)
                ...
                for (n = this.items[--a].animate(l); a--; )
                    this.items[a] && !this.items[a].removed && this.items[a].animateWith(n, l, l),
            ...
            e.print = function(t, e, i, r, n, s, o, a) {
                ...
                o = M(L(o || 0, 1), -1),
                a = M(L(a || 1, 3), 1);
                var h, l = G(i)[X](""), u = 0, c = 0, p = "";
                if (I.is(r, "string") && (r = this.getFont(r)),
                r) {
                    ...
                    for (var f = r.face.bbox[X](H), d = +f[0], g = f[3] - f[1], x = 0, v = +f[1] + ("baseline" == s ? g + +r.face.descent : g / 2), y = 0, m = l.length; y < m; y++) {
                        if ("\n" == l[y])
                            ...
                            var b = c && r.glyphs[l[y - 1]] || {}
                              , w = r.glyphs[l[y]];
                            u += c ? (b.w || r.w) + (b.k && b.k[l[y]] || 0) + r.w * o : 0,
                            c = 1
                        }
            ...
            ae = document,
            he = "DOMContentLoaded",
            null == ae.readyState && ae.addEventListener && (ae.addEventListener(he, le = function() {
    ...
    , function(t, e, i) {
        ...
        (y = function(t, e) {
            t = String(t);
            var i, r = d, n = Array.prototype.slice.call(arguments, 2), s = y.listeners(t), o = 0, a = [], h = {}, l = [], u = f;
            f = t;
            for (var c = d = 0, p = s.length; c < p; c++)
                "zIndex"in s[c] && (a.push(s[c].zIndex),
                s[c].zIndex < 0 && (h[s[c].zIndex] = s[c]));
            for (a.sort(x); a[o] < 0; )
                if (i = h[a[o++]],
                l.push(i.apply(e, n)),
                d)
            ...
            for (c = 0; c < p; c++)
                if ("zIndex"in (i = s[c]))
                    if (i.zIndex == a[o]) {
                        if (l.push(i.apply(e, n)),
                        d)
                            break;
                        do {
                            if ((i = h[a[++o]]) && l.push(i.apply(e, n)),
                            d)
                                break
                        } while (i)
                    } else
                        h[i.zIndex] = i;
                else if (l.push(i.apply(e, n)),
                d)
                    break;
            return d = r,
            f = u,
        ...
        y.listeners = function(t) {
            var e, i, r, n, s, o, a, h, l = t.split(g), u = v, c = [u], p = [];
            for (n = 0,
            s = l.length; n < s; n++) {
                for (h = [],
                o = 0,
        ...
        y.on = function(t, e) {
            ...
            for (var i = t.split(g), r = v, n = 0, s = i.length; n < s; n++)
                r = (r = r.n).hasOwnProperty(i[n]) && r[i[n]] || (r[i[n]] = {
                    n: {}
                });
            for (r.f = r.f || [],
            n = 0,
        ...
        y.off = y.unbind = function(t, e) {
            if (t) {
                var i, r, n, s, o, a, h, l = t.split(g), u = [v];
                for (s = 0,
                o = l.length; s < o; s++)
    ...
    , function(t, e, i) {
        ...
        void 0 === (n = function(S) {
            if (!S || S.svg) {
                ...
                var E = function(t, e) {
                    if (e)
                        for (var i in "string" == typeof t && (t = E(t)),
                        e)
                            e[B](i) && ("xlink:" == i.substring(0, 6) ? t.setAttributeNS(F, i.substring(6), M(e[i])) : t.setAttribute(i, M(e[i])));
                    else
                        (t = S._g.doc.createElementNS("http://www.w3.org/2000/svg", t)).style && (t.style.webkitTapHighlightColor = "rgba(0,0,0,0)");
                    return t
                }
                  , P = function(t, e) {
                    var n = "linear"
                    ...
                    if (!l) {
                        ...
                        if (!f)
                            return null;
                        if (i = i.replace(/[\(\)\s,\xb0#]/g, "_"),
                        t.gradient && i != t.gradient.id && (a.defs.removeChild(t.gradient),
                        delete t.gradient),
                        !t.gradient) {
                            l = E(n + "Gradient", {
                                id: i
                  ...
                  , I = function(t, e, i) {
                    if ("path" == t.type) {
                        for (var r, n, s, o, a, h = M(e).toLowerCase().split("-"), l = t.paper, u = i ? "end" : "start", c = t.node, p = t.attrs, f = p["stroke-width"], d = h.length, g = "classic", x = 3, v = 3, y = 5; d--; )
                            switch (h[d]) {
                            case "block":
                            case "classic":
                            case "oval":
                        ...
                        t._.arrows ? i ? (t._.arrows.endPath && A[t._.arrows.endPath]--,
                        t._.arrows.endMarker && A[t._.arrows.endMarker]--) : (t._.arrows.startPath && A[t._.arrows.startPath]--,
                        t._.arrows.startMarker && A[t._.arrows.startMarker]--) : t._.arrows = {},
                        "none" != g) {
                            ...
                            _ ? (A[b]++,
                            w = _.getElementsByTagName("use")[0]) : (_ = E(E("marker"), {
                                id: b,
                                markerHeight: v,
                                markerWidth: x,
                                orient: "auto",
                            ...
                            n = i ? (r = t._.arrows.startdx * f || 0,
                            S.getTotalLength(p.path) - k * f) : (r = k * f,
                            S.getTotalLength(p.path) - (t._.arrows.enddx * f || 0)),
                            (a = {})["marker-" + u] = "url(#" + b + ")",
                            ...
                            n = i ? (r = t._.arrows.startdx * f || 0,
                            S.getTotalLength(p.path) - r) : (r = 0,
                            S.getTotalLength(p.path) - (t._.arrows.enddx * f || 0)),
                            t._.arrows[u + "Path"] && E(c, {
                  ...
                  , f = function(t, e) {
                    ...
                    for (var s in i.style.visibility = "hidden",
                    e)
                        if (e[B](s)) {
                            if (!S._availableAttrs[B](s))
                                continue;
                            var o = e[s];
                            switch (r[s] = o,
                            s) {
                            ...
                            case "path":
                                ...
                                t._.dirty = 1,
                                t._.arrows && ("startString"in t._.arrows && I(t, t._.arrows.startString),
                                "endString"in t._.arrows && I(t, t._.arrows.endString, 1)));
                                break;
                            case "width":
                                if (i.setAttribute(s, o),
                                t._.dirty = 1,
                                !r.fx)
                                    break;
                                s = "x",
                            ...
                            case "src":
                                ...
                                break;
                            case "stroke-width":
                                1 == t._.sx && 1 == t._.sy || (o /= k(C(t._.sx), C(t._.sy)) || 1),
                                i.setAttribute(s, o),
                                r["stroke-dasharray"] && D(t, r["stroke-dasharray"], e),
                                t._.arrows && ("startString"in t._.arrows && I(t, t._.arrows.startString),
                                "endString"in t._.arrows && I(t, t._.arrows.endString, 1));
                                break;
                            ...
                            case "fill":
                                ...
                                if (y.error) {
                                    ...
                                    delete e.gradient,
                                    delete r.gradient,
                                    !S.is(r.opacity, "undefined") && S.is(e.opacity, "undefined") && E(i, {
                                        opacity: r.opacity
                                    }),
                            ...
                            case "stroke":
                                ...
                                "stroke" == s && y[B]("opacity") && E(i, {
                                    "stroke-opacity": 1 < y.opacity ? y.opacity / 100 : y.opacity
                                }),
                                "stroke" == s && t._.arrows && ("startString"in t._.arrows && I(t, t._.arrows.startString),
                                "endString"in t._.arrows && I(t, t._.arrows.endString, 1));
                                break;
                            case "gradient":
                            ...
                            case "fill-opacity":
                                if (r.gradient) {
                                    (m = S._g.doc.getElementById(i.getAttribute("fill").replace(/^url\(#|\)$/g, ""))) && (b = m.getElementsByTagName("stop"),
                                    E(b[b.length - 1], {
                                        "stop-opacity": o
                                    }));
                                    break
                  ...
                  , R = function(t, e) {
                    if ("text" == t.type && (e[B]("text") || e[B]("font") || e[B]("font-size") || e[B]("x") || e[B]("y"))) {
                        ...
                        if (e[B]("text")) {
                            ...
                            for (h = 0,
                            l = (a = r.getElementsByTagName("tspan")).length; h < l; h++)
                                h ? E(a[h], {
                                    dy: 1.2 * n,
                                    x: i.x
                                }) : E(a[0], {
                ...
                t.rotate = function(t, e, i) {
                    if (this.removed)
                        return this;
                    if ((t = M(t).split(L)).length - 1 && (e = x(t[1]),
                    i = x(t[2])),
                    t = x(t[0]),
                    null == i && (e = i),
                    null == e || null == i) {
                ...
                ,
                t.translate = function(t, e) {
                    return this.removed || ((t = M(t).split(L)).length - 1 && (e = x(t[1])),
                    t = x(t[0]) || 0,
                    e = +e || 0,
                ...
                t.transform = function(t) {
                    ...
                    if (null == t)
                        return e.transform;
                    if (S._extractTransform(this, t),
                    this.clip && E(this.clip, {
                    ...
                    return e.transform = this.matrix.toTransformString(),
                    this
                }
                ,
                t.hide = function() {
                ...
                t.remove = function() {
                    ...
                    if (!this.removed && t.parentNode) {
                        ...
                        this.removeData(),
                        this)
                            this[i] = "function" == typeof this[i] ? S._removedFactory(i) : null;
                        this.removed = !0
                    }
                }
                ,
                ...
                t.attr = function(t, e) {
                    ...
                    if (null == e && S.is(t, "string")) {
                        ...
                        for (var n = t.split(L), s = {}, o = 0, a = n.length; o < a; o++)
                            (t = n[o])in this.attrs ? s[t] = this.attrs[t] : S.is(this.paper.customAttributes[t], "function") ? s[t] = this.paper.customAttributes[t].def : s[t] = S._availableAttrs[t];
                        return a - 1 ? s : s[n[0]]
                    }
                ...
                t.toFront = function() {
                    ...
                    var e = this.paper;
                    return e.top != this && S._tofront(this, e),
                    this
                }
                ,
                t.toBack = function() {
                ...
                t.blur = function(t) {
                    ...
                    if (0 != +t) {
                        ...
                        e._blur && (e._blur.parentNode.removeChild(e._blur),
                        delete e._blur,
                        delete e.attrs.blur),
                ...
                S._engine.create = function() {
                    ...
                    var o, a = E("svg"), h = "overflow:hidden;";
                    return i = i || 0,
                    r = r || 0,
                    E(a, {
                        height: s = s || 342,
                    ...
                    1 == e ? (a.style.cssText = h + "position:absolute;left:" + i + "px;top:" + r + "px",
                    S._g.doc.body.appendChild(a),
                    o = 1) : (a.style.cssText = h + "position:relative",
                ...
                S._engine.setViewBox = function(t, e, i, r, n) {
                    ...
                    var s, o, a = this.getSize(), h = k(i / a.width, r / a.height), l = this.top, u = n ? "xMidYMid meet" : "xMinYMin";
                    for (s = null == t ? (this._vbSize && (h = 1),
                    delete this._vbSize,
                    "0 0 " + this.width + " " + this.height) : (this._vbSize = h,
                    t + " " + e + " " + i + " " + r),
                    E(this.canvas, {
                        viewBox: s,
                        preserveAspectRatio: u
                    }); h && l; )
                        o = "stroke-width"in l.attrs ? l.attrs["stroke-width"] : 1,
                        l.attr({
                            "stroke-width": o
                        }),
                        l._.dirty = 1,
                ...
                S.prototype.renderfix = function() {
                    ...
                    var r = -e.e % 1
                      , n = -e.f % 1;
                    (r || n) && (r && (this._left = (this._left + r) % 1,
                ...
                S.prototype.clear = function() {
                    ...
                    (this.desc = E("desc")).appendChild(S._g.doc.createTextNode("Created with Raphaël " + S.version)),
                ...
                S.prototype.remove = function() {
                    ...
                    this)
                        this[t] = "function" == typeof this[t] ? S._removedFactory(t) : null
                }
                ;
                var e = S.st;
                for (var i in t)
                    t[B](i) && !e[B](i) && (e[i] = function(i) {
                        return function() {
                            var e = arguments;
                            return this.forEach(function(t) {
                                t[i].apply(t, e)
        ...
        void 0 === (n = function(E) {
            if (!E || E.vml) {
                  ...
                  , U = function(t, e, i, r, n, s) {
                    ...
                    e && i) {
                        ...
                        h || o.fillsize) {
                            ...
                            x = x && x[0],
                            l.removeChild(x),
                            h && (g = y(s, a.x(h[0], h[1]), a.y(h[0], h[1])),
                            x.position = g.dx * c + Y + g.dy * c),
                            o.fillsize && (x.size = o.fillsize[0] * v(e) + Y + o.fillsize[1] * v(i)),
                            l.appendChild(x)
                        }
                ...
                var $, Z = function(t, e, i) {
                    for (var r = z(e).toLowerCase().split("-"), n = i ? "end" : "start", s = r.length, o = "classic", a = "medium", h = "medium"; s--; )
                        switch (r[s]) {
                        case "block":
                        case "classic":
                        case "oval":
                    ...
                    for (var h in e)
                        e[P](h) && (r[h] = e[h]);
                    if (s && (r.path = E._getPath[t.type](t),
                    t._.dirty = 1),
                    ...
                    (e.path && "path" == t.type || s) && (i.path = function(t) {
                        var e = /[ahqstv]/gi
                          , i = E._pathToAbsolute;
                        if (z(t).match(e) && (i = E._path2curve),
                        e = /[clmz]/g,
                        ...
                        return r.join(Y)
                    }(~z(r.path).toLowerCase().indexOf("r") ? E._pathToAbsolute(r.path) : r.path),
                    t._.dirty = 1,
                    "image" == t.type && (t._.fillpos = [r.x, r.y],
                    ...
                    o) {
                        var l = +r.cx
                          ...
                          , c = +r.rx || +r.r || 0
                          , p = +r.ry || +r.r || 0;
                        i.path = E.format("ar{0},{1},{2},{3},{4},{1},{4},{1}x", D((l - c) * X), D((u - p) * X), D((l + c) * X), D((u + p) * X), D(l * X)),
                        t._.dirty = 1
                    }
                    if ("clip-rect"in e) {
                        ...
                        if (4 == f.length) {
                            ...
                            i.clipRect || (g.position = "absolute",
                            g.top = 0,
                            g.left = 0,
                    ...
                    if ("arrow-start"in e && Z(a, e["arrow-start"]),
                    "arrow-end"in e && Z(a, e["arrow-end"], 1),
                    null != e.opacity || null != e.fill || null != e.src || null != e.stroke || null != e["stroke-width"] || null != e["stroke-opacity"] || null != e["fill-opacity"] || null != e["stroke-dasharray"] || null != e["stroke-miterlimit"] || null != e["stroke-linejoin"] || null != e["stroke-linecap"]) {
                        var v = i.getElementsByTagName(N);
                        if (!(v = v && v[0]) && (v = $(N)),
                        "image" == t.type && e.src && (v.src = e.src),
                        e.fill && (v.on = !0),
                        null != v.on && "none" != e.fill && null !== e.fill || (v.on = !1),
                        v.on && e.fill) {
                            ...
                            if (y) {
                                ...
                                v.src = "",
                                v.type = "solid",
                                E.getRGB(e.fill).error && (a.type in {
                                    circle: 1,
                                    ellipse: 1
                                } || "r" != z(e.fill).charAt()) && Q(a, e.fill, v) && (r.fill = "none",
                                r.gradient = e.fill,
                                v.rotate = !1)
                        }
                        ...
                        w.opacity = b,
                        e["stroke-linejoin"] && (w.joinstyle = e["stroke-linejoin"] || "miter"),
                        w.miterlimit = e["stroke-miterlimit"] || 8,
                        e["stroke-linecap"] && (w.endcap = "butt" == e["stroke-linecap"] ? "flat" : "square" == e["stroke-linecap"] ? "square" : "round"),
                    ...
                    if ("text" == a.type) {
                        ...
                        n.fontSize = 100 * M + "px",
                        a.textpath.string && (B.innerHTML = z(a.textpath.string).replace(/</g, "&#60;").replace(/&/g, "&#38;").replace(/\n/g, "<br>"));
                        var L = B.getBoundingClientRect();
                        a.W = r.w = (L.right - L.left) / 100,
                        a.H = r.h = (L.bottom - L.top) / 100,
                        a.X = r.x,
                        a.Y = r.y + a.H / 2,
                        ("x"in e || "y"in e) && (a.path.v = E.format("m{0},{1}l{2},{1}", D(r.x * X), D(r.y * X), D(r.x * X) + 1));
                    ...
                    e = (e = z(e).replace(E._radial_gradient, function(t, e, i) {
                        return n = "radial",
                        e && i && (e = I(e),
                        i = I(i),
                        .25 < r(e - .5, 2) + r(i - .5, 2) && (i = c.sqrt(.25 - r(e - .5, 2)) * (2 * (.5 < i) - 1) + .5),
                        s = e + Y + i),
                        ""
                    })).split(/\s*\-\s*/),
                    "linear" == n) {
                    ...
                    a.length) {
                        ...
                        "radial" == n ? (i.type = "gradientTitle",
                        i.focus = "100%",
                        i.focussize = "0 0",
                        i.focusposition = s,
                        i.angle = 0) : (i.type = "gradient",
                        i.angle = (270 - o) % 360),
                        t.appendChild(i)
                    }
                    return 1
                ...
                t.transform = function(t) {
                    if (null == t)
                        return this._.transform;
                    var e, i = this.paper._viewBoxShift, r = i ? "s" + [i.scale, i.scale] + "-1-1t" + [i.dx, i.dy] : "";
                    i && (e = t = z(t).replace(/\.{3}|\u2026/g, this._.transform || "")),
                    E._extractTransform(this, r + t);
                    var n, s = this.matrix.clone(), o = this.skew, a = this.node, h = ~z(this.attrs.fill).indexOf("-"), l = !z(this.attrs.fill).indexOf("url(");
                    if (s.translate(1, 1),
                    l || h || "image" == this.type)
                        if (o.matrix = "1 0 0 1",
                        o.offset = "0 0",
                        ...
                        o.matrix = z(s),
                        o.offset = s.offset();
                    return null !== e && (this._.transform = e,
                    E._extractTransform(this, e)),
                    this
                }
                ,
                t.rotate = function(t, e, i) {
                    if (this.removed)
                        return this;
                    if (null != t) {
                        if ((t = z(t).split(G)).length - 1 && (e = I(t[1]),
                        i = I(t[2])),
                        t = I(t[0]),
                        null == i && (e = i),
                        null == e || null == i) {
                ...
                ,
                t.translate = function(t, e) {
                    return this.removed || ((t = z(t).split(G)).length - 1 && (e = I(t[1])),
                    t = I(t[0]) || 0,
                    e = +e || 0,
                ...
                t.attr = function(t, e) {
                    ...
                    if (null == e && E.is(t, "string")) {
                        if (t == N && "none" == this.attrs.fill && this.attrs.gradient)
                            return this.attrs.gradient;
                        for (var n = t.split(G), s = {}, o = 0, a = n.length; o < a; o++)
                            (t = n[o])in this.attrs ? s[t] = this.attrs[t] : E.is(this.paper.customAttributes[t], "function") ? s[t] = this.paper.customAttributes[t].def : s[t] = E._availableAttrs[t];
                        return a - 1 ? s : s[n[0]]
                    }
                ...
                ,
                t.insertAfter = function(t) {
                    return this.removed || (t.constructor == E.st.constructor && (t = t[t.length - 1]),
                ...
                ,
                t.insertBefore = function(t) {
                    return this.removed || (t.constructor == E.st.constructor && (t = t[0]),
                ...
                t.blur = function(t) {
                    ...
                    e.filter = i + Y + " progid:DXImageTransform.Microsoft.Blur(pixelradius=" + (+t || 1.5) + ")",
                    e.margin = E.format("-{0}px 0 0 -{0}px", D(+t || 1.5))) : (e.filter = i,
                    e.margin = 0,
                ...
                E._engine.text = function(t, e, i, r) {
                    ...
                    i = i || 0,
                    r = r || "",
                    s.v = E.format("m{0},{1}l{2},{1}", D(e * X), D(i * X), D(e * X) + 1),
                    s.textpathok = !0,
                    o.string = z(r),
                    o.on = !0,
                    n.style.cssText = u,
                ...
                E._engine.setViewBox = function(t, e, i, r, n) {
                    ...
                    var s, o, a = this.getSize(), h = a.width, l = a.height;
                    return n && (i * (s = l / r) < h && (t -= (h - i * s) / 2 / s),
                ...
                E._engine.create = function() {
                    ...
                    h.cssText = E.format("top:0;left:0;width:{0};height:{1};display:inline-block;position:relative;clip:rect(0 {0} {1} 0);overflow:hidden", r, i),
                    1 == e ? (E._g.doc.body.appendChild(a),
                    h.left = n + "px",
                    h.top = s + "px",
                    h.position = "absolute") : e.firstChild ? e.insertBefore(a, e.firstChild) : e.appendChild(a),
...
function() {
    var x, _, t, e, a = [].slice, u = function(t, e) {
        return function() {
            return t.apply(e, arguments)
        }
    }, n = {}.hasOwnProperty, s = function(t, e) {
        for (var i in e)
            n.call(e, i) && (t[i] = e[i]);
        function r() {
            this.constructor = t
    ...
    _.EventEmitter = function() {
        ...
        t.prototype.fire = function() {
            ...
            null != this.handlers && null != this.handlers[i]) {
                for (o = [],
                r = 0,
                n = (s = this.handlers[i]).length; r < n; r++)
                    e = s[r],
    ...
    _.commas = function(t) {
        ...
        return null != t ? (r = t < 0 ? "-" : "",
        e = Math.abs(t),
        r += (i = Math.floor(e).toFixed(0)).replace(/(?=(?:\d{3})+$)(?!^)/g, ","),
    ...
    _.Grid = function(t) {
        function e(t) {
            ...
            var s = this;
            if ("string" == typeof t.element ? this.el = x(document.getElementById(t.element)) : this.el = x(t.element),
            null == this.el || 0 === this.el.length)
                throw new Error("Graph container element not found");
            "static" === this.el.css("position") && this.el.css("position", "relative"),
            this.options = x.extend({}, this.gridDefaults, this.defaults || {}, t),
            ...
            this.el.bind("mousemove", function(t) {
                ...
                n = t.pageX - i.left,
                s.selectFrom ? (e = s.data[s.hitTest(Math.min(n, s.selectFrom))]._x,
                r = s.data[s.hitTest(Math.max(n, s.selectFrom))]._x - e,
                s.selectionRect.attr({
                    x: e,
                    width: r
                })) : s.fire("hovermove", n, t.pageY - i.top)
            }),
            this.el.bind("mouseleave", function(t) {
                return s.selectFrom && (s.selectionRect.hide(),
                s.selectFrom = null),
                s.fire("hoverout")
            }),
        ...
        e.prototype.setData = function(r, t) {
            ...
            return null == t && (t = !0),
            null == (this.options.data = r) || 0 === r.length ? (this.data = [],
            this.raphael.clear(),
            void (null != this.hover && this.hover.hide())) : (f = this.cumulative ? 0 : null,
            d = this.cumulative ? 0 : null,
            0 < this.options.goals.length && (i = Math.min.apply(Math, this.options.goals),
            ...
            this.data = function() {
                ...
                e = r.length; t < e; o = ++t)
                    ...
                    (a = {
                        src: h
                    }).label = h[this.options.xkey],
                    this.options.parseTime ? (a.x = _.parseDate(a.label),
                    this.options.dateFormat ? a.label = this.options.dateFormat(a.x) : "number" == typeof a.label && (a.label = new Date(a.label).toString())) : (a.x = o,
                    this.options.xLabelFormat && (a.label = this.options.xLabelFormat(a))),
                    u = 0,
                    a.y = function() {
                        var t, e, i, r;
                        for (i = this.options.ykeys,
                        r = [],
                        s = t = 0,
                        e = i.length; t < e; s = ++t)
                            p = i[s],
                            "string" == typeof (g = h[p]) && (g = parseFloat(g)),
                            null != g && "number" != typeof g && (g = null),
                            null != g && (this.cumulative ? u += g : null != f ? (f = Math.max(g, f),
                            d = Math.min(g, d)) : f = d = g),
                            this.cumulative && null != u && (f = Math.max(u, f),
                            d = Math.min(u, d)),
                            r.push(g);
                        return r
                    }
            ...
            .call(this),
            this.options.parseTime && (this.data = this.data.sort(function(t, e) {
                return (t.x > e.x) - (e.x > t.x)
            })),
            this.xmin = this.data[0].x,
            this.xmax = this.data[this.data.length - 1].x,
            this.events = [],
            0 < this.options.events.length && (this.options.parseTime ? this.events = function() {
                var t, e, i, r;
                for (r = [],
                t = 0,
                e = (i = this.options.events).length; t < e; t++)
                    n = i[t],
                    r.push(_.parseDate(n));
                return r
            }
            .call(this) : this.events = this.options.events,
            ...
            this.ymin === this.ymax && (d && (this.ymin -= 1),
            this.ymax += 1),
            !0 !== (x = this.options.axes) && "both" !== x && "y" !== x && !0 !== this.options.grid || (this.options.ymax === this.gridDefaults.ymax && this.options.ymin === this.gridDefaults.ymin ? (this.grid = this.autoGridLines(this.ymin, this.ymax, this.options.numLines),
        ...
        e.prototype.yboundary = function(t, e) {
            var i, r;
            return "string" == typeof (i = this.options["y" + t]) ? "auto" === i.slice(0, 4) ? 5 < i.length ? (r = parseInt(i.slice(5), 10),
            null == e ? r : Math[t](e, r)) : null != e ? e : 0 : parseInt(i, 10) : i
        }
        ,
        e.prototype.autoGridLines = function(t, e, i) {
            ...
            r = Math.ceil(e / h) * h,
            a = (r - n) / (i - 1),
            1 === h && 1 < a && Math.ceil(a) !== a && (a = Math.ceil(a),
            r = n + a * (i - 1)),
            n < 0 && 0 < r && (n = Math.floor(t / a) * a,
            r = Math.ceil(e / a) * a),
            a < 1 ? (s = Math.floor(Math.log(a) / Math.log(10)),
            function() {
                var t, e;
                for (e = [],
                l = t = n; 0 < a ? t <= r : r <= t; l = t += a)
        ...
        e.prototype._calc = function() {
            ...
            if (i = this.el.width(),
            e = this.el.height(),
            (this.elementWidth !== i || this.elementHeight !== e || this.dirty) && (this.elementWidth = i,
            ...
            !0 !== (o = this.options.axes) && "both" !== o && "y" !== o || (s = function() {
                var t, e, i, r;
                for (r = [],
                t = 0,
                e = (i = this.grid).length; t < e; t++)
                    n = i[t],
            ...
            !0 !== (a = this.options.axes) && "both" !== a && "x" !== a || (t = function() {
                var t, e, i;
                for (i = [],
                r = t = 0,
                e = this.data.length; 0 <= e ? t < e : e < t; r = 0 <= e ? ++t : --t)
                    i.push(this.measureText(this.data[r].text, -this.options.xLabelAngle).height);
                return i
            }
            .call(this),
        ...
        e.prototype.drawGrid = function() {
            ...
            if (!1 !== this.options.grid || !0 === (n = this.options.axes) || "both" === n || "y" === n) {
                for (a = [],
                i = 0,
                r = (s = this.grid).length; i < r; i++)
                    t = s[i],
                    e = this.transY(t),
                    !0 !== (o = this.options.axes) && "both" !== o && "y" !== o || this.drawYAxisLabel(this.left - this.options.padding / 2, e, this.yAxisFormat(t)),
                    this.options.grid ? a.push(this.drawGridLine("M" + this.left + "," + e + "H" + (this.left + this.width))) : a.push(void 0);
                return a
            }
        }
        ,
        e.prototype.drawGoals = function() {
            ...
            for (o = [],
            i = r = 0,
            n = (s = this.options.goals).length; r < n; i = ++r)
                e = s[i],
        ...
        e.prototype.drawEvents = function() {
            ...
            for (o = [],
            i = r = 0,
            n = (s = this.events).length; r < n; i = ++r)
                e = s[i],
        ...
        e.prototype.endRange = function(t) {
            var e, i;
            if (this.selectFrom)
                return i = Math.min(this.selectFrom, t),
    ...
    _.parseDate = function(t) {
        ...
        return "number" == typeof t ? t : (i = t.match(/^(\d+) Q(\d)$/),
        n = t.match(/^(\d+)-(\d+)$/),
        s = t.match(/^(\d+)-(\d+)-(\d+)$/),
        a = t.match(/^(\d+) W(\d+)$/),
        h = t.match(/^(\d+)-(\d+)-(\d+)[ T](\d+):(\d+)(Z|([+-])(\d\d):?(\d\d))?$/),
        l = t.match(/^(\d+)-(\d+)-(\d+)[ T](\d+):(\d+):(\d+(\.\d+)?)(Z|([+-])(\d\d):?(\d\d))?$/),
        i ? new Date(parseInt(i[1], 10),3 * parseInt(i[2], 10) - 1,1).getTime() : n ? new Date(parseInt(n[1], 10),parseInt(n[2], 10) - 1,1).getTime() : s ? new Date(parseInt(s[1], 10),parseInt(s[2], 10) - 1,parseInt(s[3], 10)).getTime() : a ? (4 !== (u = new Date(parseInt(a[1], 10),0,1)).getDay() && u.setMonth(0, 1 + (4 - u.getDay() + 7) % 7),
        u.getTime() + 6048e5 * parseInt(a[2], 10)) : h ? h[6] ? (o = 0,
        "Z" !== h[6] && (o = 60 * parseInt(h[8], 10) + parseInt(h[9], 10),
        "+" === h[7] && (o = 0 - o)),
        Date.UTC(parseInt(h[1], 10), parseInt(h[2], 10) - 1, parseInt(h[3], 10), parseInt(h[4], 10), parseInt(h[5], 10) + o)) : new Date(parseInt(h[1], 10),parseInt(h[2], 10) - 1,parseInt(h[3], 10),parseInt(h[4], 10),parseInt(h[5], 10)).getTime() : l ? (c = parseFloat(l[6]),
        e = Math.floor(c),
        r = Math.round(1e3 * (c - e)),
        l[8] ? (o = 0,
        "Z" !== l[8] && (o = 60 * parseInt(l[10], 10) + parseInt(l[11], 10),
        "+" === l[9] && (o = 0 - o)),
        Date.UTC(parseInt(l[1], 10), parseInt(l[2], 10) - 1, parseInt(l[3], 10), parseInt(l[4], 10), parseInt(l[5], 10) + o, e, r)) : new Date(parseInt(l[1], 10),parseInt(l[2], 10) - 1,parseInt(l[3], 10),parseInt(l[4], 10),parseInt(l[5], 10),e,r).getTime()) : new Date(parseInt(t, 10),0,1).getTime())
    }
    ,
    _.Hover = function() {
        function t(t) {
        ...
        t.prototype.update = function(t, e, i) {
            return t ? (this.html(t),
            this.show(),
            this.moveTo(e, i)) : this.hide()
        }
        ,
        ...
        t.prototype.moveTo = function(t, e) {
            ...
            null != e ? (a = e - i - 10) < 0 && s < (a = e + 10) + i && (a = s / 2 - i / 2) : a = s / 2 - i / 2,
            this.el.css({
                left: n + "px",
                top: parseInt(a) + "px"
            })
    ...
    _.Line = function(t) {
        function e(t) {
            if (this.hilight = u(this.hilight, this),
        ...
        e.prototype.calcPoints = function() {
            ...
            for (r = [],
            t = 0,
            e = (i = this.data).length; t < e; t++)
                (n = i[t])._x = this.transX(n.x),
                n._y = function() {
                    var t, e, i, r;
                    for (r = [],
                    t = 0,
                    e = (i = n.y).length; t < e; t++)
        ...
        e.prototype.hitTest = function(t) {
            ...
            if (0 === this.data.length)
                return null;
            for (e = i = 0,
            r = (n = this.data.slice(1)).length; i < r && !(t < (n[e]._x + this.data[e]._x) / 2); e = ++i)
                ;
            return e
        }
        ,
        ...
        e.prototype.displayHoverForRow = function(t) {
            var e;
            return null != t ? ((e = this.hover).update.apply(e, this.hoverContentForRow(t)),
            this.hilight(t)) : (this.hover.hide(),
            this.hilight())
        }
        ,
        e.prototype.hoverContentForRow = function(t) {
            var e, i, r, n, s, o, a;
            for (e = "<div class='morris-hover-row-label'>" + (r = this.data[t]).label + "</div>",
            i = s = 0,
            o = (a = r.y).length; s < o; i = ++s)
                n = a[i],
                e += "<div class='morris-hover-point' style='color: " + this.colorFor(r, i, "label") + "'>\n  " + this.options.labels[i] + ":\n  " + this.yLabelFormat(n) + "\n</div>";
        ...
        e.prototype.generatePaths = function() {
            ...
            return this.paths = function() {
                ...
                for (r = [],
                s = t = 0,
                e = this.options.ykeys.length; 0 <= e ? t < e : e < t; s = 0 <= e ? ++t : --t)
                    a = "boolean" == typeof this.options.smooth ? this.options.smooth : (i = this.options.ykeys[s],
        ...
        e.prototype.draw = function() {
            var t;
            if (!0 !== (t = this.options.axes) && "both" !== t && "x" !== t || this.drawXAxis(),
            this.drawSeries(),
        ...
        e.prototype.drawXAxis = function() {
            ...
            for (l = this.bottom + this.options.padding / 2,
            a = h = null,
            t = function(t, e) {
                var i, r, n, s, o;
                ...
                0 !== u.options.xLabelAngle && (s = -.5 * o.width * Math.cos(u.options.xLabelAngle * Math.PI / 180),
                i.transform("t" + s + ",0...")),
                r = i.getBBox(),
                (null == h || h >= r.x + r.width || null != a && a >= r.x) && 0 <= r.x && r.x + r.width < u.el.width() ? (0 !== u.options.xLabelAngle && (n = 1.25 * u.options.gridTextSize / Math.sin(u.options.xLabelAngle * Math.PI / 180),
                a = r.x - n),
                h = r.x - u.options.xLabelMargin) : i.remove()
            }
            ,
        ...
        e.prototype.drawSeries = function() {
            ...
            t = e = r = this.options.ykeys.length - 1; r <= 0 ? e <= 0 : 0 <= e; t = r <= 0 ? ++e : --e)
                this._drawLineFor(t);
            for (s = [],
            t = i = n = this.options.ykeys.length - 1; n <= 0 ? i <= 0 : 0 <= i; t = n <= 0 ? ++i : --i)
        ...
        e.prototype._drawPointFor = function(t) {
            var e, i, r, n, s, o;
            for (this.seriesPoints[t] = [],
            o = [],
            r = 0,
            n = (s = this.data).length; r < n; r++)
                (e = null) != (i = s[r])._y[t] && (e = this.drawLinePoint(i._x, i._y[t], this.colorFor(i, t, "point"), t)),
        ...
        e.createPath = function(t, e, i) {
            ...
            o = c = 0,
            p = t.length; c < p; o = ++c)
                null != (r = t[o]).y && (null != u.y ? e ? (n = s[o],
                h = s[o - 1],
                a = (r.x - u.x) / 4,
                l += "C" + (u.x + a) + "," + Math.min(i, u.y + a * h) + "," + (r.x - a) + "," + Math.min(i, r.y - a * n) + "," + r.x + "," + r.y) : l += "L" + r.x + "," + r.y : e && null == s[o] || (l += "M" + r.x + "," + r.y)),
                u = r;
            return l
        }
        ,
        ...
        e.prototype.hilight = function(t) {
            ...
            if (null !== this.prevHilight && this.prevHilight !== t)
                for (e = i = 0,
                n = this.seriesPoints.length - 1; 0 <= n ? i <= n : n <= i; e = 0 <= n ? ++i : --i)
                    this.seriesPoints[e][this.prevHilight] && this.seriesPoints[e][this.prevHilight].animate(this.pointShrinkSeries(e));
            if (null !== t && this.prevHilight !== t)
                for (e = r = 0,
                s = this.seriesPoints.length - 1; 0 <= s ? r <= s : s <= r; e = 0 <= s ? ++r : --r)
                    this.seriesPoints[e][t] && this.seriesPoints[e][t].animate(this.pointGrowSeries(e));
    ...
    _.labelSeries = function(t, e, i, r, n) {
        ...
        void 0 === (c = _.LABEL_SPECS[r]))
            for (f = 0,
            d = (g = _.AUTO_LABEL_ORDER).length; f < d; f++)
                if (h = g[f],
                a >= (u = _.LABEL_SPECS[h]).span) {
                    c = u;
                    break
                }
        for (void 0 === c && (c = _.LABEL_SPECS.second),
        n && (c = x.extend({}, c, {
            fmt: n
        })),
        s = c.start(o),
        l = []; (p = s.getTime()) <= e; )
            t <= p && l.push([c.fmt(s), p]),
            c.incr(s);
        return l
    }
    ,
    ...
    _.AUTO_LABEL_ORDER = ["decade", "year", "month", "week", "day", "hour", "30min", "15min", "10min", "5min", "minute", "30sec", "15sec", "10sec", "5sec", "second"],
    _.Area = function(t) {
        var i;
        function r(t) {
            var e;
            if (!(this instanceof _.Area))
                return new _.Area(t);
            e = x.extend({}, i, t),
        ...
        r.prototype.calcPoints = function() {
            ...
            e = (i = this.data).length; t < e; t++)
                ...
                n._y = function() {
                    ...
                    e = (i = n.y).length; t < e; t++)
                        o = i[t],
                        this.options.behaveLikeLine ? r.push(this.transY(o)) : (s += o || 0,
        ...
        r.prototype.drawSeries = function() {
            ...
            a = [],
            i = 0,
            r = (e = this.options.behaveLikeLine ? function() {
                s = [];
                for (var t = 0, e = this.options.ykeys.length - 1; 0 <= e ? t <= e : e <= t; 0 <= e ? t++ : t--)
                    s.push(t);
                return s
            }
            .apply(this) : function() {
                o = [];
                for (var t = n = this.options.ykeys.length - 1; n <= 0 ? t <= 0 : 0 <= t; n <= 0 ? t++ : t--)
                    o.push(t);
                return o
            }
            .apply(this)).length; i < r; i++)
                t = e[i],
                this._drawFillFor(t),
                this._drawLineFor(t),
        ...
        r.prototype._drawFillFor = function(t) {
            var e;
            if (null !== (e = this.paths[t]))
                return e = e + "L" + this.transX(this.xmax) + "," + this.bottom + "L" + this.transX(this.xmin) + "," + this.bottom + "Z",
    ...
    _.Bar = function(t) {
        function e(t) {
            if (this.onHoverOut = u(this.onHoverOut, this),
            this.onHoverMove = u(this.onHoverMove, this),
            this.onGridClick = u(this.onGridClick, this),
        ...
        return s(e, t),
        e.prototype.init = function() {
            if (this.cumulative = this.options.stacked,
        ...
        e.prototype.calc = function() {
            ...
            if (this.calcBars(),
            !1 === this.options.hideHover)
                return (t = this.hover).update.apply(t, this.hoverContentForRow(this.data.length - 1))
        }
        ,
        e.prototype.calcBars = function() {
            ...
            for (o = [],
            t = e = 0,
            i = (r = this.data).length; e < i; t = ++e)
                (n = r[t])._x = this.left + this.width * (t + .5) / this.data.length,
                o.push(n._y = function() {
                    var t, e, i, r;
                    for (r = [],
                    t = 0,
                    e = (i = n.y).length; t < e; t++)
                        null != (s = i[t]) ? r.push(this.transY(s)) : r.push(null);
                    return r
                }
                .call(this));
            return o
        ...
        e.prototype.drawXAxis = function() {
            ...
            p = [],
            t = u = 0,
            c = this.data.length; 0 <= c ? u < c : c < u; t = 0 <= c ? ++u : --u)
                ...
                0 !== this.options.xLabelAngle && (n = -.5 * h.width * Math.cos(this.options.xLabelAngle * Math.PI / 180),
                e.transform("t" + n + ",0...")),
                (null == o || o >= i.x + i.width || null != s && s >= i.x) && 0 <= i.x && i.x + i.width < this.el.width() ? (0 !== this.options.xLabelAngle && (r = 1.25 * this.options.gridTextSize / Math.sin(this.options.xLabelAngle * Math.PI / 180),
                s = i.x - r),
                p.push(o = i.x - this.options.xLabelMargin)) : p.push(e.remove());
            return p
        }
        ,
        e.prototype.drawSeries = function() {
            var n, s, o, a, h, l, u, t, c, p, f, e, d, g, x;
            return o = this.width / this.options.data.length,
            t = this.options.stacked ? 1 : this.options.ykeys.length,
            n = (o * this.options.barSizeRatio - this.options.barGap * (t - 1)) / t,
            ...
            this.bars = function() {
                ...
                e = i.length; t < e; a = ++t)
                    ...
                    r.push(function() {
                        ...
                        p = t = 0,
                        e = i.length; t < e; p = ++t)
                            null !== (g = i[p]) ? (s = x ? (d = Math.min(g, x),
                            Math.max(g, x)) : (d = g,
                            this.bottom),
                            l = this.left + a * o + u,
                            this.options.stacked || (l += p * (n + this.options.barGap)),
                            f = s - d,
                            this.options.verticalGridCondition && this.options.verticalGridCondition(c.x) && this.drawBar(this.left + a * o, this.top, o, Math.abs(this.top - this.bottom), this.options.verticalGridColor, this.options.verticalGridOpacity, this.options.barRadius),
                            this.options.stacked && (d -= h),
                            this.drawBar(l, d, n, f, this.colorFor(c, p, "bar"), this.options.barOpacity, this.options.barRadius),
                            r.push(h += f)) : r.push(null);
                        return r
                    }
                    .call(this));
                return r
        ...
        ,
        e.prototype.hitTest = function(t) {
            return 0 === this.data.length ? null : (t = Math.max(Math.min(t, this.right), this.left),
            Math.min(this.data.length - 1, Math.floor((t - this.left) / (this.width / this.data.length))))
        }
        ,
        e.prototype.onGridClick = function(t, e) {
            var i;
        ...
        e.prototype.hoverContentForRow = function(t) {
            ...
            o = (a = r.y).length; s < o; i = ++s)
                ...
                e += "<div class='morris-hover-point' style='color: " + this.colorFor(r, i, "label") + "'>\n  " + this.options.labels[i] + ":\n  " + this.yLabelFormat(n) + "\n</div>";
            return "function" == typeof this.options.hoverCallback && (e = this.options.hoverCallback(t, this.options, e, r.src)),
            [e, this.left + (t + .5) * this.width / this.data.length]
        }
        ,
        e.prototype.drawXAxisLabel = function(t, e, i) {
            return this.raphael.text(t, e, i).attr("font-size", this.options.gridTextSize).attr("font-family", this.options.gridTextFamily).attr("font-weight", this.options.gridTextWeight).attr("fill", this.options.gridTextColor)
    ...
    _.Donut = function(t) {
        function e(t) {
            ...
            var e = this;
            if (!(this instanceof _.Donut))
                return new _.Donut(t);
            if (this.options = x.extend({}, this.defaults, t),
            "string" == typeof t.element ? this.el = x(document.getElementById(t.element)) : this.el = x(t.element),
            null === this.el || 0 === this.el.length)
                throw new Error("Graph placeholder not found.");
            void 0 !== t.data && 0 !== t.data.length && (this.raphael = new Raphael(this.el[0]),
            this.options.resize && x(window).bind("resize", function(t) {
        ...
        e.prototype.redraw = function() {
            ...
            this.segments = [],
            r = f = 0,
            x = (m = this.values).length; f < x; r = ++f)
                h = s + a + t * (m[r] / u),
                (l = new _.DonutSegment(e,i,2 * c,c,s,h,this.data[r].color || this.options.colors[n % this.options.colors.length],this.options.backgroundColor,n,this.raphael)).render(),
                this.segments.push(l),
                l.on("hover", this.select),
                l.on("click", this.click),
                s = h,
                n += 1;
            for (this.text1 = this.drawEmptyDonutLabel(e, i - 10, this.options.labelColor, 15, 800),
            this.text2 = this.drawEmptyDonutLabel(e, i + 10, this.options.labelColor, 14),
            o = Math.max.apply(Math, this.values),
            w = [],
            d = n = 0,
            v = (b = this.values).length; d < v; d++) {
                if (b[d] === o) {
                    this.select(n);
                    break
                }
        ...
        e.prototype.select = function(t) {
            var e, i, r, n;
            for (i = 0,
            r = (n = this.segments).length; i < r; i++)
                n[i].deselect();
