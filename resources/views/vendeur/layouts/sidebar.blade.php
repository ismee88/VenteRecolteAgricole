...
<div class="sidebar-scroll">
    <div class="user-account">
        ...
        <img src="{{asset('frontend/img/profil.jpg')}}" class="rounded-circle user-photo" alt="User Profile Picture">
        <div class="dropdown">
            <span>Bienvenue,</span>
            <a href="javascript:void(0);" class="dropdown-toggle user-name" data-toggle="dropdown"><strong>{{auth('vendeur')->user()->nom_complet}}</strong></a>
        ...
        <div class="tab-pane active" id="menu">
            <nav id="left-sidebar-nav" class="sidebar-nav">
                <ul id="main-menu" class="metismenu">                            
                    ...
                    <li>
                        <a href="{{route('vendeur')}}" class=""><i class="icon-grid"></i> <span>Tableau de bord</span></a>
                    </li>
                    
                    <li>
                        <a href="#App" class="has-arrow"><i class="icon-briefcase"></i> <span>Gestion des produits</span></a>
                        <ul>
                            <li><a href="{{route('vendeur-produit.index')}}">Afficher produit</a></li>
                            <li><a href="{{route('vendeur-produit.create')}}">Ajouter produit</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="{{route('vendeur-commande.index')}}" class=""><i class="icon-layers"></i> <span>Gestion des commandes</span></a>
                    </li>
                    <li>
