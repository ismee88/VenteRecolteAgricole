            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                    <div class="inlineblock text-center  m-l-15 hidden-sm">
                        <h4 class="float-right">Produit Total : {{\App\Models\Produit::count()}}</h4>
                    </div>
                    <div>
                        <a class="btn btn-sm btn-outline-secondary" href="{{route('produit.create')}}">Créer Produit</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            @foreach ($produits as $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('produit.edit', $item->id)}}" data-toggle="tooltip" title="Modifier" class="float-left btn btn-sm btn-outline-warning ml-2" data-placement="bottom"><i class="fa fa-edit"></i></a>
                                        
                                        <form class="float-left ml-2" action="{{route('produit.destroy', $item->id)}}" method="post">
                                            @csrf
                                            @method('delete')
