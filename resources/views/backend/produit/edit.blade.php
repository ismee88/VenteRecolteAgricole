                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control show-tick" name="vendeur_id">
                                    <option value="">-- Vendeur --</option>
                                    @foreach (\App\Models\Vendeur::where('statut','active')->get() as $vendeur)
                                        <option value="{{$vendeur->id}}" {{$vendeur->id == $produit->vendeur_id ? 'selected' : ''}}>{{$vendeur->nom_complet}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
